...
},beforePageText:"Trang",afterPageText:"/ {pages}",displayMsg:"Hiển thị từ {from} tới {to} của {total} dòng",nav:{first:{iconCls:"pagination-first",handler:function(){
...
$.messager.defaults={ok:"Đồng ý",cancel:"Thoát"};
})(jQuery);
(function($){
...
$(_4ab).addClass("filebox-f").textbox($.extend({},opts,{buttonText:opts.buttonText?("<label for=\""+id+"\">"+opts.buttonText+"</label>"):""}));
...
var node=tree.tree("find",_988[i]);
if(node){
...
$.fn.combotree=function(_98d,_98e){
if(typeof _98d=="string"){
var _98f=$.fn.combotree.methods[_98d];
if(_98f){
return _98f(this,_98e);
}else{
return this.combo(_98d,_98e);
}
}
_98d=_98d||{};
return this.each(function(){
var _990=$.data(this,"combotree");
if(_990){
$.extend(_990.options,_98d);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_98d)});
}
_97b(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _991=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_991.width,height:_991.height,originalValue:_991.originalValue,disabled:_991.disabled,readonly:_991.readonly});
},clone:function(jq,_992){
var t=jq.combo("clone",_992);
...
},setValues:function(jq,_993){
return jq.each(function(){
_986(this,_993);
});
},setValue:function(jq,_994){
return jq.each(function(){
_986(this,[_994]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_995){
return $.extend({},$.fn.combo.parseOptions(_995),$.fn.tree.parseOptions(_995));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _996(_997){
var _998=$.data(_997,"combogrid");
var opts=_998.options;
var grid=_998.grid;
$(_997).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combogrid("panel");
var _999=p.outerHeight()-p.height();
var _99a=p._size("minHeight");
var _99b=p._size("maxHeight");
$(this).combogrid("grid").datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_99a?_99a-_999:""),maxHeight:(_99b?_99b-_999:"")});
opts.onShowPanel.call(this);
}}));
var _99c=$(_997).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_99c);
_998.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _99d=$(_997).combo("getValues");
var _99e=opts.onSelect;
opts.onSelect=function(){
};
_9a8(_997,_99d,_998.remainText);
opts.onSelect=_99e;
opts.onLoadSuccess.apply(_997,arguments);
},onClickRow:_99f,onSelect:function(_9a0,row){
_9a1();
opts.onSelect.call(this,_9a0,row);
},onUnselect:function(_9a2,row){
_9a1();
opts.onUnselect.call(this,_9a2,row);
},onSelectAll:function(rows){
_9a1();
...
function _99f(_9a3,row){
_998.remainText=false;
_9a1();
if(!opts.multiple){
$(_997).combo("hidePanel");
}
opts.onClickRow.call(this,_9a3,row);
};
function _9a1(){
...
if(!opts.multiple){
$(_997).combo("setValues",(vv.length?vv:[""]));
}else{
$(_997).combo("setValues",vv);
}
if(!_998.remainText){
$(_997).combo("setText",ss.join(opts.separator));
}
};
};
...
var grid=_9a5.grid;
var _9a6=grid.datagrid("getRows").length;
if(!_9a6){
return;
}
...
var _9a7;
if(!tr.length){
_9a7=(dir=="next"?0:_9a6-1);
}else{
var _9a7=parseInt(tr.attr("datagrid-row-index"));
_9a7+=(dir=="next"?1:-1);
if(_9a7<0){
_9a7=_9a6-1;
}
...
grid.datagrid("highlightRow",_9a7);
if(opts.selectOnNavigation){
_9a5.remainText=false;
grid.datagrid("selectRow",_9a7);
}
};
function _9a8(_9a9,_9aa,_9ab){
var _9ac=$.data(_9a9,"combogrid");
var opts=_9ac.options;
var grid=_9ac.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _9ad=$(_9a9).combo("getValues");
var _9ae=$(_9a9).combo("options");
var _9af=_9ae.onChange;
_9ae.onChange=function(){
};
grid.datagrid("clearSelections");
if(!$.isArray(_9aa)){
_9aa=_9aa.split(opts.separator);
}
for(var i=0;i<_9aa.length;i++){
var _9b0=grid.datagrid("getRowIndex",_9aa[i]);
if(_9b0>=0){
grid.datagrid("selectRow",_9b0);
ss.push(rows[_9b0][opts.textField]);
}else{
ss.push(_9aa[i]);
}
}
$(_9a9).combo("setValues",_9ad);
_9ae.onChange=_9af;
if(!_9ab){
var s=ss.join(opts.separator);
if($(_9a9).combo("getText")!=s){
$(_9a9).combo("setText",s);
}
}
$(_9a9).combo("setValues",_9aa);
};
function _9b1(_9b2,q){
var _9b3=$.data(_9b2,"combogrid");
var opts=_9b3.options;
var grid=_9b3.grid;
_9b3.remainText=true;
if(opts.multiple&&!q){
_9a8(_9b2,[],true);
}else{
_9a8(_9b2,[q],true);
...
if(opts.filter.call(_9b2,q,row)){
...
function _9b4(_9b5){
var _9b6=$.data(_9b5,"combogrid");
var opts=_9b6.options;
var grid=_9b6.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_9b6.remainText=false;
if(tr.length){
var _9b7=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_9b7);
}else{
grid.datagrid("selectRow",_9b7);
}
}else{
grid.datagrid("selectRow",_9b7);
}
...
$(_9b5).combogrid("setValues",vv);
if(!opts.multiple){
$(_9b5).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_9b8,_9b9){
if(typeof _9b8=="string"){
var _9ba=$.fn.combogrid.methods[_9b8];
if(_9ba){
return _9ba(this,_9b9);
}else{
return this.combo(_9b8,_9b9);
}
}
_9b8=_9b8||{};
return this.each(function(){
var _9bb=$.data(this,"combogrid");
if(_9bb){
$.extend(_9bb.options,_9b8);
}else{
_9bb=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_9b8)});
}
_996(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _9bc=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_9bc.width,height:_9bc.height,originalValue:_9bc.originalValue,disabled:_9bc.disabled,readonly:_9bc.readonly});
},grid:function(jq){
return $.data(jq[0],"combogrid").grid;
},setValues:function(jq,_9bd){
return jq.each(function(){
_9a8(this,_9bd);
});
},setValue:function(jq,_9be){
return jq.each(function(){
_9a8(this,[_9be]);
});
},clear:function(jq){
...
$.fn.combogrid.parseOptions=function(_9bf){
var t=$(_9bf);
return $.extend({},$.fn.combo.parseOptions(_9bf),$.fn.datagrid.parseOptions(_9bf),$.parser.parseOptions(_9bf,["idField","textField","mode"]));
};
...
(function($){
function _9c0(_9c1){
var _9c2=$.data(_9c1,"datebox");
var opts=_9c2.options;
$(_9c1).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_9c3(this);
_9c4(this);
_9c5(this);
_9d3(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_9c2.calendar){
var _9c6=$(_9c1).combo("panel").css("overflow","hidden");
_9c6.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_9c6);
...
_9c2.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_9c2.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _9c7=this.target;
var opts=$(_9c7).datebox("options");
_9d3(_9c7,opts.formatter.call(_9c7,date));
$(_9c7).combo("hidePanel");
opts.onSelect.call(_9c7,date);
}});
}
$(_9c1).combo("textbox").parent().addClass("datebox");
$(_9c1).datebox("initValue",opts.value);
function _9c3(_9c8){
var opts=$(_9c8).datebox("options");
var _9c9=$(_9c8).combo("panel");
_9c9.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _9ca=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_9ca].handler.call(e.target,_9c8);
}
});
};
function _9c4(_9cb){
var _9cc=$(_9cb).combo("panel");
if(_9cc.children("div.datebox-button").length){
return;
}
var _9cd=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_9cc);
var tr=_9cd.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_9cb):btn.text).appendTo(td);
t.attr("datebox-button-index",i);
}
tr.find("td").css("width",(100/opts.buttons.length)+"%");
};
function _9c5(_9ce){
var _9cf=$(_9ce).combo("panel");
var cc=_9cf.children("div.datebox-calendar-inner");
_9cf.children()._outerWidth(_9cf.width());
_9c2.calendar.appendTo(cc);
_9c2.calendar[0].target=_9ce;
if(opts.panelHeight!="auto"){
var _9d0=_9cf.height();
_9cf.children().not(cc).each(function(){
_9d0-=$(this).outerHeight();
});
cc._outerHeight(_9d0);
}
_9c2.calendar.calendar("resize");
};
};
function _9d1(_9d2,q){
_9d3(_9d2,q,true);
};
function _9d4(_9d5){
var _9d6=$.data(_9d5,"datebox");
var opts=_9d6.options;
var _9d7=_9d6.calendar.calendar("options").current;
if(_9d7){
_9d3(_9d5,opts.formatter.call(_9d5,_9d7));
$(_9d5).combo("hidePanel");
}
};
function _9d3(_9d8,_9d9,_9da){
var _9db=$.data(_9d8,"datebox");
var opts=_9db.options;
var _9dc=_9db.calendar;
$(_9d8).combo("setValue",_9d9);
_9dc.calendar("moveTo",opts.parser.call(_9d8,_9d9));
if(!_9da){
if(_9d9){
_9d9=opts.formatter.call(_9d8,_9dc.calendar("options").current);
$(_9d8).combo("setText",_9d9).combo("setValue",_9d9);
}else{
$(_9d8).combo("setText",_9d9);
}
}
};
$.fn.datebox=function(_9dd,_9de){
if(typeof _9dd=="string"){
var _9df=$.fn.datebox.methods[_9dd];
if(_9df){
...
_9dd=_9dd||{};
return this.each(function(){
var _9e0=$.data(this,"datebox");
if(_9e0){
$.extend(_9e0.options,_9dd);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_9dd)});
}
_9c0(this);
});
};
...
return $.extend($.data(jq[0],"datebox").options,{width:_9e1.width,height:_9e1.height,originalValue:_9e1.originalValue,disabled:_9e1.disabled,readonly:_9e1.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_9e2){
return jq.each(function(){
var opts=$(this).datebox("options");
var _9e3=opts.value;
if(_9e3){
_9e3=opts.formatter.call(this,opts.parser.call(this,_9e3));
}
$(this).combo("initValue",_9e3).combo("setText",_9e3);
});
},setValue:function(jq,_9e4){
return jq.each(function(){
_9d3(this,_9e4);
});
},reset:function(jq){
...
$.fn.datebox.parseOptions=function(_9e5){
return $.extend({},$.fn.combo.parseOptions(_9e5),$.parser.parseOptions(_9e5,["sharedCalendar"]));
};
...
_9d1(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_9e6){
return $(_9e6).datebox("options").currentText;
},handler:function(_9e7){
$(_9e7).datebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_9d4(_9e7);
}},{text:function(_9e8){
return $(_9e8).datebox("options").closeText;
...
(function($){
function _9ea(_9eb){
var _9ec=$.data(_9eb,"datetimebox");
var opts=_9ec.options;
$(_9eb).datebox($.extend({},opts,{onShowPanel:function(){
var _9ed=$(this).datetimebox("getValue");
_9f3(this,_9ed,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_9eb).removeClass("datebox-f").addClass("datetimebox-f");
$(_9eb).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_9ec.spinner){
var _9ee=$(_9eb).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_9ee.children("div.datebox-calendar-inner"));
_9ec.spinner=p.children("input");
}
_9ec.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_9eb).datetimebox("initValue",opts.value);
};
function _9ef(_9f0){
var c=$(_9f0).datetimebox("calendar");
var t=$(_9f0).datetimebox("spinner");
var date=c.calendar("options").current;
return new Date(date.getFullYear(),date.getMonth(),date.getDate(),t.timespinner("getHours"),t.timespinner("getMinutes"),t.timespinner("getSeconds"));
};
function _9f1(_9f2,q){
_9f3(_9f2,q,true);
};
function _9f4(_9f5){
var opts=$.data(_9f5,"datetimebox").options;
var date=_9ef(_9f5);
_9f3(_9f5,opts.formatter.call(_9f5,date));
$(_9f5).combo("hidePanel");
};
function _9f3(_9f6,_9f7,_9f8){
var opts=$.data(_9f6,"datetimebox").options;
$(_9f6).combo("setValue",_9f7);
if(!_9f8){
if(_9f7){
var date=opts.parser.call(_9f6,_9f7);
$(_9f6).combo("setText",opts.formatter.call(_9f6,date));
$(_9f6).combo("setValue",opts.formatter.call(_9f6,date));
}else{
$(_9f6).combo("setText",_9f7);
}
}
var date=opts.parser.call(_9f6,_9f7);
$(_9f6).datetimebox("calendar").calendar("moveTo",date);
$(_9f6).datetimebox("spinner").timespinner("setValue",_9f9(date));
function _9f9(date){
function _9fa(_9fb){
return (_9fb<10?"0":"")+_9fb;
};
var tt=[_9fa(date.getHours()),_9fa(date.getMinutes())];
if(opts.showSeconds){
tt.push(_9fa(date.getSeconds()));
}
return tt.join($(_9f6).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_9fc,_9fd){
if(typeof _9fc=="string"){
var _9fe=$.fn.datetimebox.methods[_9fc];
if(_9fe){
return _9fe(this,_9fd);
}else{
return this.datebox(_9fc,_9fd);
}
}
_9fc=_9fc||{};
return this.each(function(){
var _9ff=$.data(this,"datetimebox");
if(_9ff){
$.extend(_9ff.options,_9fc);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_9fc)});
}
_9ea(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _a00=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_a00.originalValue,disabled:_a00.disabled,readonly:_a00.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_a01){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _a02=opts.value;
if(_a02){
_a02=opts.formatter.call(this,opts.parser.call(this,_a02));
}
$(this).combo("initValue",_a02).combo("setText",_a02);
});
...
$.fn.datetimebox.parseOptions=function(_a04){
var t=$(_a04);
return $.extend({},$.fn.datebox.parseOptions(_a04),$.parser.parseOptions(_a04,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_9f1(this,q);
}},buttons:[{text:function(_a05){
return $(_a05).datetimebox("options").currentText;
},handler:function(_a06){
var opts=$(_a06).datetimebox("options");
_9f3(_a06,opts.formatter.call(_a06,new Date()));
$(_a06).datetimebox("hidePanel");
}},{text:function(_a07){
return $(_a07).datetimebox("options").okText;
},handler:function(_a08){
_9f4(_a08);
}},{text:function(_a09){
return $(_a09).datetimebox("options").closeText;
},handler:function(_a0a){
$(_a0a).datetimebox("hidePanel");
}}],formatter:function(date){
var h=date.getHours();
var M=date.getMinutes();
var s=date.getSeconds();
function _a0b(_a0c){
return (_a0c<10?"0":"")+_a0c;
};
var _a0d=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_a0b(h)+_a0d+_a0b(M);
...
var _a0e=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_a0e);
var hour=parseInt(tt[0],10)||0;
var _a0f=parseInt(tt[1],10)||0;
var _a10=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_a0f,_a10);
}});
})(jQuery);
(function($){
function init(_a11){
var _a12=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_a11);
var t=$(_a11);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_a12.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_a12.bind("_resize",function(e,_a13){
if($(this).hasClass("easyui-fluid")||_a13){
_a14(_a11);
}
return false;
});
...
if(_a16){
if(_a16.width){
opts.width=_a16.width;
}
if(_a16.height){
opts.height=_a16.height;
}
}
_a18._size(opts);
if(opts.mode=="h"){
_a18.css("height","");
_a18.children("div").css("height","");
}else{
_a18.css("width","");
_a18.children("div").css("width","");
_a18.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_a18._outerHeight());
}
_a19(_a15);
};
function _a1a(_a1b){
var _a1c=$.data(_a1b,"slider");
...
_a1e(aa);
function _a1e(aa){
var rule=_a1d.find("div.slider-rule");
var _a1f=_a1d.find("div.slider-rulelabel");
rule.empty();
_a1f.empty();
for(var i=0;i<aa.length;i++){
var _a20=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_a20);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_a1f);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_a20,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_a20,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
_a24.removeClass("slider-h slider-v slider-disabled");
_a24.addClass(opts.mode=="h"?"slider-h":"slider-v");
_a24.addClass(opts.disabled?"slider-disabled":"");
var _a25=_a24.find(".slider-inner");
_a25.html("<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
if(opts.range){
_a25.append("<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>");
}
_a24.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
_a23.isDragging=true;
},onStartDrag:function(){
opts.onSlideStart.call(_a22,opts.range?opts.values:opts.value);
},onStopDrag:function(e){
_a27(opts.mode=="h"?e.data.left:e.data.top);
var v=opts.range?opts.values:opts.value;
opts.onSlideEnd.call(_a22,v);
opts.onComplete.call(_a22,v);
_a23.isDragging=false;
}});
_a24.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_a23.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
_a27(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top));
opts.onComplete.call(_a22,opts.range?opts.values:opts.value);
});
function _a27(pos){
var _a28=_a29(_a22,pos);
...
_a28<m?v1=_a28:v2=_a28;
}
}
$(_a22).slider("setValues",[v1,v2]);
}else{
$(_a22).slider("setValue",_a28);
}
};
};
function _a2a(_a2b,_a2c){
var _a2d=$.data(_a2b,"slider");
var opts=_a2d.options;
var _a2e=_a2d.slider;
var _a2f=opts.values;
opts.values=[];
_a2e.find(".slider-value").remove();
var name=$(_a2b).attr("sliderName")||"";
for(var i=0;i<_a2c.length;i++){
var _a30=_a2c[i];
if(_a30<opts.min){
_a30=opts.min;
}
...
var _a31=$("<input type=\"hidden\" class=\"slider-value\">").appendTo(_a2e);
_a31.attr("name",name);
_a31.val(_a30);
opts.values.push(_a30);
var _a32=_a2e.find(".slider-handle:eq("+i+")");
var tip=_a32.next();
var pos=_a33(_a2b,_a30);
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_a2b,_a30));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _a34="left:"+pos+"px;";
_a32.attr("style",_a34);
tip.attr("style",_a34+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _a34="top:"+pos+"px;";
_a32.attr("style",_a34);
tip.attr("style",_a34+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
}
opts.value=opts.range?opts.values.join(","):opts.values[0];
$(_a2b).val(opts.value);
if(_a2f.join(",")!=opts.values.join(",")){
opts.onChange.call(_a2b,(opts.range?opts.values:opts.values[0]),(opts.range?_a2f:_a2f[0]));
}
};
function _a19(_a35){
var opts=$.data(_a35,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_a2a(_a35,opts.range?opts.values:[opts.value]);
opts.onChange=fn;
};
function _a33(_a36,_a37){
var _a38=$.data(_a36,"slider");
var opts=_a38.options;
var _a39=_a38.slider;
var size=opts.mode=="h"?_a39.width():_a39.height();
var pos=opts.converter.toPosition.call(_a36,_a37,size);
if(opts.mode=="v"){
pos=_a39.height()-pos;
}
if(opts.reversed){
...
function _a29(_a3a,pos){
var _a3b=$.data(_a3a,"slider");
var opts=_a3b.options;
var _a3c=_a3b.slider;
var size=opts.mode=="h"?_a3c.width():_a3c.height();
var _a3d=opts.converter.toValue.call(_a3a,opts.mode=="h"?(opts.reversed?(size-pos):pos):(size-pos),size);
return _a3d.toFixed(0);
};
$.fn.slider=function(_a3e,_a3f){
if(typeof _a3e=="string"){
return $.fn.slider.methods[_a3e](this,_a3f);
}
_a3e=_a3e||{};
return this.each(function(){
var _a40=$.data(this,"slider");
if(_a40){
$.extend(_a40.options,_a3e);
}else{
_a40=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_a3e),slider:init(this)});
$(this).removeAttr("disabled");
}
...
_a2a(this,opts.range?[opts.min,opts.max]:[opts.min]);
});
},reset:function(jq){
return jq.each(function(){
var opts=$(this).slider("options");
_a2a(this,opts.range?opts.originalValues:[opts.originalValue]);
});
},enable:function(jq){
return jq.each(function(){
...
$.fn.slider.parseOptions=function(_a44){
var t=$(_a44);
return $.extend({},$.parser.parseOptions(_a44,["width","height","mode",{reversed:"boolean",showTip:"boolean",range:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,range:false,value:0,values:[0,100],min:0,max:100,step:1,rule:[],tipFormatter:function(_a45){
return _a45;
},converter:{toPosition:function(_a46,size){
var opts=$(this).slider("options");
return (_a46-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_a47,_a48){
},onSlideStart:function(_a49){
},onSlideEnd:function(_a4a){
},onComplete:function(_a4b){
}};
})(jQuery);
