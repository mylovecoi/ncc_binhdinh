...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr>Đơn vị: UBND <?php echo $ahs[0]; ?></nobr></td>
			<td>
			</td>
		...
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
            <td  style="text-align: center;font-weight: bold;">DANH SÁCH ĐĂNG KÝ THAM GIA BẢO HIỂM Y TẾ</td>
		</tr>		
	</table>
...
$stt =0;	
$sql = "Select hoten,mathe,ngaysinh,gioitinh,truquan,noidk,thtu,thden From ".ktnam(date('Y'))." Where xacnhan='DK' and xa='".$ahs[0]."' and huyen='".$ahs[1]."'";
//$sql = "Select hoten,mathe,ngaysinh,gioitinh,truquan,noidk,thtu,thden From ".ktnam(date('Y'))." Where (xacnhan='DK' or xacnhan='Chuyển 1' or xacnhan='Chuyển 2') and xa='".$ahs[0]."' and huyen='".$ahs[1]."'";
