...
?>
    <table cellspacing="0" cellpadding="0" border="0">        
		...
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
            <td  style="text-align: center;font-weight: bold;">DANH SÁCH HỒ SƠ CHỜ DUYỆT</td>
		</tr>		
	</table>
...
$stt =0;$sql="";
if ($tungay != "" && $denngay != "")	
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Chuyển 2' and huyen Like '".str_replace('_',' ',$tenhuyen)."%' and ngaylaphs Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
else
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Chuyển 2' and huyen Like '".str_replace('_',' ',$tenhuyen)."%'";
