...
if ($tungay != "" && $denngay != "")
{		
	$sql = "Select ngayqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and phanloaihoso='".$nt."' and huyen Like '".str_replace('_',' ',$tenhuyen)."%' and ngayqd Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
}
else
{
	$sql = "Select ngayqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and phanloaihoso='".$nt."' and huyen Like '".str_replace('_',' ',$tenhuyen)."%'";
}
