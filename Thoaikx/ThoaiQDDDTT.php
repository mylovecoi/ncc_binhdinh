...
$(document).ready(function(){
	...
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Quyết định điều dưỡng tập trung</strong></h4>
		</div>
			<div class="modal-body">
				  <form name="thoai" onsubmit="return kt()" role="form" method="Post" class="form-horizontal" action="QDDDTT.php">
