...
$stt =0;$sql="";
if ($tungay != "" && $denngay != "")	
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and xa='".$tentinh."' and ngaytraqd Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
else
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and xa='".$tentinh."'";
