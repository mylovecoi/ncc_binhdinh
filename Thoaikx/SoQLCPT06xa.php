...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr>Đơn vị: UBND <?php echo $tenxa; ?></nobr></td>
			<td>
			</td>
		...
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
            <td  style="text-align: center;font-weight: bold;">SỔ QUẢN LÝ CẤP PHƯƠNG TIỆN TRỢ GIÚP, DỤNG CỤ CHỈNH HÌNH</td>
		</tr>		
	</table>
	<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
		<tr>
			...
			<th  width="20%">Nơi đăng ký thường trú</th>
			<th  width="10%">Số hồ sơ NCC</th>
			<th  width="5%">Số sổ theo dõi trang cấp</th>
			<th  width="15%">Loại phương tiện trợ giúp và dụng cụ chỉnh hình, vật phẩm phụ được hưởng</th>
...
while ($row = mysqli_fetch_array($qrsql)) {		
		...
		echo "<td style='text-align: left;'><nobr>".($hoten != $row[0]?$row['truquan']:"")."</nobr></td>";
		...
		echo "<td style='text-align: center;'>" . $row['ngaycap'] . "</td>";
		echo "</tr>";
		$hoten = $row[0];
	}
