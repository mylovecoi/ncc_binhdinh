...
if(isset($_POST['create1'])){
	//$tenhuyen = $_POST['tinhkx'];
	$tentinh = $_POST['huyenkx'];
	//$tendv=$_POST['tinhdv'];
	//$tenct=$_POST['tinh'];
}
?>
<body>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr><?php echo $tendv;?></nobr></td>
			<td>
			</td>
	...
	<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
		<tr>
			...
			<th rowspan ="2" width="5%">Thông tin di vật</th>
			<th colspan = "2" width="15%">Thông tin quy tập hoặc an táng hài cốt trước khi tiếp nhận</th>
			<th colspan = "2" width="15%">Thông tin về di chuyển hài cốt liệt sĩ</th>
			<th rowspan ="2" width="10%">Cấp bậc, chức vụ</th>
			<th rowspan ="2" width="10%">Đơn vị</th>
			<th rowspan ="2" width="5%">Ngày tháng năm hi sinh</th>
...
$stt =0;
//if ($ahs[0] != "" && $ahs[1] != "")
	$sql="Select * From molietsy where tennghiatrang='".str_replace('_',' ',$tentinh)."'";
//else if ($ahs[0] == "" && $ahs[1] != "")
...
$stt++;
	...
	echo "<tr>";
		...
		echo "<td style='text-align: left;'>".$row['capbac'].", ".$row['chucvu']."</td>";
		echo "<td style='text-align: left;'>".$row['donvi']."</td>";
		echo "<td style='text-align: left;'>".$row['ngayhs']."</td>";
		echo "<td style='text-align: center;'></td>";
	echo "</tr>";
}
?>
