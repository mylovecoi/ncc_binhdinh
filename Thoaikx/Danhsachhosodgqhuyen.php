...
if(isset($_POST['create'])){
	$tungay = $_POST['Tu'];
	$denngay = $_POST['Den'];
	$tenhuyen = $_POST['huyenkx'];
	$tentinh = $_POST['tinhkx'];	
}
?>
    <table cellspacing="0" cellpadding="0" border="0">        
		...
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
            <td  style="text-align: center;font-weight: bold;">DANH SÁCH HỒ SƠ ĐANG GIẢI QUYẾT</td>
		</tr>		
	</table>
	<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
		<tr>
			<th  width="5%">STT</th>
			<th  width="20%">Ngày lập hs</th>
			<th  width="20%">Họ và tên</th>
			<th  width="25%">Trú quán</th>
			<th  width="10%">Nội dung xin trợ cấp</th>
		</tr>				
<?php 
...
$stt =0;$sql="";
if ($tungay != "" && $denngay != "")	
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where (trangthai='Chuyển 1' or trangthai='Chuyển 2') and xa Like '".str_replace('_',' ',$tenhuyen)."%' and ngaylaphs Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
else
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where (trangthai='Chuyển 1' or trangthai='Chuyển 2') and xa Like '".str_replace('_',' ',$tenhuyen)."%'";
//echo $sql;
...
while ($row = mysqli_fetch_array($qrsql)) {		
		...
		echo "<td style='text-align: left;'><nobr>".ngaythang($row['ngaylaphs'])."</nobr></td>";
