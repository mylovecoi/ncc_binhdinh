...
$stt =0;$sql="";
if ($tungay != "" && $denngay != "")	
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where (trangthai='Chuyển 1' or trangthai='Chuyển 2') and xa='".$tentinh."' and ngaylaphs Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
else
	$sql = "Select ngaylaphs,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where (trangthai='Chuyển 1' or trangthai='Chuyển 2') and xa='".$tentinh."'";
