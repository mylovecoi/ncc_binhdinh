...
?>
    <table cellspacing="0" cellpadding="0" border="0">        
		...
		<tr>
            <td  style="text-align: center;font-weight: bold;">Tên đơn vị: <?php echo $tenhuyen; ?></td>
		</tr>
		<tr>
...
$stt =0;$sql="";
if ($tungay != "" && $denngay != "")	
	$sql = "Select noitraqd,ngaytraqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and captraoqd='".$nt."' and xa Like '".str_replace('_',' ',$tenhuyen)."%' and ngaytraqd Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
else
	$sql = "Select noitraqd,ngaytraqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and captraoqd='".$nt."' and xa Like '".str_replace('_',' ',$tenhuyen)."%'";
