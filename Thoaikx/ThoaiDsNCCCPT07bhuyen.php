...
$(document).ready(function(){
	...
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Danh sách người có công với cách mạng và thân nhân được cấp phương tiện trợ giúp, dụng cụ chỉnh hình</strong></h4>
		</div>
			<div class="modal-body">
				  <form name="thoai" role="form" method="Post" class="form-horizontal" action="DsNCCCPT07bhuyen.php">					
