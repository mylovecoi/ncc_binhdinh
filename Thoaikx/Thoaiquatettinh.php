	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<div class="modal-body">
				  <form name="thoai" role="form" method="Post" class="form-horizontal" action="quatettinh.php">
					...
					<div style="text-align:center">	
						<input name="tinh" type="text" class="form-control" style = "Display:none;" id="tinh" value = "<?php echo $madv[0];?>">
