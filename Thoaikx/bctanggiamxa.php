...
if ($tungay != "" && $denngay != "")
{		
	$sql = "Select ngayqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and phanloaihoso='".$nt."' and xa='".str_replace('_',' ',$tentinh)."' and ngayqd Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
}
else
{
	$sql = "Select ngayqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and phanloaihoso='".$nt."' and xa='".str_replace('_',' ',$tentinh)."'";
}
