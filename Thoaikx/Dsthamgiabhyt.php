...
$stt =0;	
$sql = "Select hoten,mathe,ngaysinh,gioitinh,truquan,noidk,thtu,thden From ".ktnam($nambc)." Where xacnhan='Duyệt' and thang=".$thangbc." and xa='".$tenxa."' and huyen='".$tenhuyen."'";
