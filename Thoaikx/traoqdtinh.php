...
$stt =0;$sql="";
if ($tungay != "" && $denngay != "")	
	$sql = "Select noitraqd,ngaytraqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and captraoqd='".$nt."' and huyen Like '".str_replace('_',' ',$tenhuyen)."%' and ngaytraqd Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
else
	$sql = "Select noitraqd,ngaytraqd,hoten,phanloai,nguoihuongtn,truquan,truquantn,noidung From thutuchc Where trangthai='Duyệt' and captraoqd='".$nt."' and huyen Like '".str_replace('_',' ',$tenhuyen)."%'";
