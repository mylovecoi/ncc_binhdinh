...
if ($xain != "")
{	
	$sql = "Select loaidoituong,mucqua,count(idquatet27) as songuoi From quatet27 Where namqua Like '".$namquain."%' and xa='".str_replace('_',' ',$xain)."' and chuyen='Duyệt' and noidung='".$noidung."'";
	$sql=$sql." Group by loaidoituong,mucqua order by mucqua";
}
else
{
	$sql = "Select loaidoituong,mucqua,count(idquatet27) as songuoi From quatet27 Where namqua Like '".$namquain."%' and huyen='".$tenhuyen."' and chuyen='Duyệt' and noidung='".$noidung."'";
	$sql=$sql." Group by loaidoituong,mucqua order by mucqua";
}
