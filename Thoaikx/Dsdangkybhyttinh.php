...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr>Đơn vị: <?php echo $tenhuyen; ?></nobr></td>
			<td>
			</td>
...
$stt =0;	
$sql = "Select hoten,mathe,ngaysinh,gioitinh,truquan,noidk,thtu,thden From ".ktnam(date('Y'))." Where xacnhan='Chuyển 2' and xa Like '%".str_replace('_',' ',$tentinh)."%'";
