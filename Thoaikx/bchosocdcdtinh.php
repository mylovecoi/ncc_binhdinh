...
$stt =0;$sql="";
if ($tungay != "" && $denngay != "")	
	$sql = sqldoituong($phanloai)." Where phanloaidc='".$noitrao."' and huyen Like '".str_replace('_',' ',$tenhuyen)."%' and ngaydc Between '".doingay1($tungay)."' and '".doingay1($denngay)."'";
else
	$sql = sqldoituong($phanloai)." Where phanloaidc='".$noitrao."' and huyen Like '".str_replace('_',' ',$tenhuyen)."%'";
//echo $sql;
