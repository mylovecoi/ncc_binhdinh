...
$sql = "Select hoten,RIGHT (ngaysinh,4) as namsinh, doituong,xa,namddlt,tinhtrangsk from dieuduong".
	" WHERE phanloaidd = 'Tập trung' and namdd = '$nambc' and chuyen = 'Duyệt' and huyen = '$tenhuyen'";
...
?>
	...
	<table cellspacing="5px"  border="0" style="font-size: 14pt;padding-left: 50px;padding-right: 20px;<?php if($inqd == 'Yes') echo "display: none";?> ">
		...
		<tr>
			<td style="text-align: center;font-weight: bold; font-style: italic;">Về việc điều dưỡng tập trung đối với người có công với cách mạng năm <?php echo $nambc;?></td>
		</tr>
		...
		<tr>
			<td style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Điều 1.</b> Thực hiện chế độ điều dưỡng tập trung năm <?php echo $nambc;?> đối với các đối tượng người có công với cách mạng do phòng Lao động - TB&XH <?php echo $tenhuyen;?> quản lý:</td>
		</tr>
		<tr>
