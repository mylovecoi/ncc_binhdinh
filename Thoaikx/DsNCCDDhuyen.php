...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr>Phòng Lao Động Thương Binh Xã Hội</nobr></td>
			<td>
			</td>
...
$sql = "Select hoten,truquan,doituong,namddlt,tinhtrangsk,phanloaidd,sotien from dieuduong WHERE namdd = '$nambc' and chuyen = 'Duyệt' and loaidd = 'Một năm một lần' and xa like '".$tenxa."%' and huyen='".$tenhuyen."' order by hoten";
...
//." order by hoten";
$sql = "Select hoten,truquan,doituong,namddlt,tinhtrangsk,phanloaidd,sotien from dieuduong WHERE namdd = '$nambc' and chuyen = 'Duyệt' and loaidd = 'Hai năm một lần' and xa like '".$tenxa."%' and huyen='".$tenhuyen."' order by hoten";
$qrsql = mysqli_query($con,$sql);
$cc = array();
while ($row = mysqli_fetch_array($qrsql)) {		
		$stt++;	
