...
$sql = "Select hoten,RIGHT (ngaysinh,4) as namsinh, doituong,xa,namddlt,tinhtrangsk from dieuduong".
	" WHERE phanloaidd = 'Tại nhà' and loaidd = 'Một năm một lần' and namdd = '$nambc' and chuyen = 'Duyệt' and huyen = '$tenhuyen'";
$qrsql = mysqli_query($con,$sql);
while($row = mysqli_fetch_array($qrsql)) {
	$tongsodt ++;
	$tongsotien +=$sotiencb;
	$cc1[] = array('hoten' => $row['hoten'],
		'namsinh' => $row['namsinh'],
...
$sql = "Select hoten,RIGHT (ngaysinh,4) as namsinh, doituong,xa,namddlt,tinhtrangsk from dieuduong".
	" WHERE phanloaidd = 'Tại nhà' and loaidd = 'Hai năm một lần' and namdd = '$nambc' and chuyen = 'Duyệt' and huyen = '$tenhuyen'";
$qrsql = mysqli_query($con,$sql);
while($row = mysqli_fetch_array($qrsql)) {
	$tongsodt ++;
	$tongsotien +=$sotiencb;
...
?>
	...
	<table cellspacing="10px"  border="0" style="font-size: 14pt;padding-left: 50px;padding-right: 20px;<?php if($inqd == 'Yes') echo "display: none";?>">
		<tr>
            <td  style="text-align: center;font-weight: bold;">QUYẾT ĐỊNH</td>
		</tr>				
		<tr>
			<td style="text-align: center;font-weight: bold; font-style: italic;">Về việc điều dưỡng tại nhà đối với người có công và thân nhân </td>
		</tr>
		...
		<tr>
			<td style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Điều 1.</b> Thực hiện chế độ điều dưỡng tại nhà năm <?php echo $nambc;?> đối với người có công với cách mạng và thân nhân do phòng  Lao động - TB&XH <?php echo $tenhuyen;?> quản lý:</td>
		</tr>
		<tr>
			<td style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Số đối tượng được điều dưỡng:  <?php echo dinhdangso($tongsodt);?> người (<?php echo docsonguoi($tongsodt);?>).</td>
		</tr>
		<tr>
		...
		<tr>
			<td style="text-align: justify;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Điều 2.</b> Các ông (bà): Trưởng phòng Người có công, Trưởng phòng Kế hoạch Tài chính, Trưởng phòng Lao động - TB&XH <?php echo $tenhuyen;?> và ông (bà) có tên tại Điều 1 căn cứ Quyết định thi hành ./.</td>
		</tr>
		<tr>
	...
	<table cellspacing="0" cellpadding="0" border="0" style="font-size: 14pt;padding-left: 50px;padding-right: 20px;<?php if($inqd == 'Yes') echo "display: none";?>">
		<tr>
			<td style="text-align: justify; font-size: 11pt;"><b><i>Nơi nhận:</i></b></br> - Như Điều 2;</br> - Lưu: VT, NCC;</td>
	...
	<table cellspacing="0" cellpadding="0" border="1" style="margin: 20px auto; border-collapse: collapse;">
		<tr>
			...
			<th  width="15%">Địa chỉ </br> (xã, phường)</th>
			<th  width="5%">Năm điều dưỡng liền kề</th>
			<th  width="10%">Tình trạng sức khỏe</th>
			<th  width="10%">Số tiền điều dưỡng</th>
