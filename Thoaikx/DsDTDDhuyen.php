...
?>
    <table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr>Phong Lao Động - Thương Binh Và Xã Hội</nobr></td>
			<td>
			</td>
...
$_sQLdv="Select distinct xa from dieuduong where huyen = '".$tenhuyen."' and xa like '".$tenxa."%' and namdd = '".$nambc."'";
			
$_qdv=mysqli_query($con,$_sQLdv);
$_aDV=array();
while($_r=mysqli_fetch_array($_qdv)){
	$_aDV[]=array('ten'=>$_r['xa']			
	);
}
//Duyệt từng đơn vị
$tongcong = 0;
...
$sql = "Select hoten,truquan,namddlt,tinhtrangsk,doituong,phanloaidd from dieuduong WHERE namdd = '$nambc' and chuyen = 'Chuyển 2' and loaidd = 'Một năm một lần' and xa = '$_madv[ten]' order by hoten";
...
//		. " order by hoten";
$sql = "Select hoten,truquan,namddlt,tinhtrangsk,doituong,phanloaidd from dieuduong WHERE namdd = '$nambc' and chuyen = 'Chuyển 2' and loaidd = 'Hai năm một lần' and xa = '$_madv[ten]' order by hoten";
$qrsql = mysqli_query($con,$sql);
$cc = array();
while ($row = mysqli_fetch_array($qrsql)) {
		$cc[$cs] = array(0 => $row['hoten'],
