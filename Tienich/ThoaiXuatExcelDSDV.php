   ...
   if(giatri == "")
	...
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title" style="text-align:center;"><strong>Kết xuất danh sách đơn vị sử dụng</strong></h4>
		</div>
			<div class="modal-body">
				  <form name="thoai" onsubmit=" return kt()" role="form" method="Post" class="form-horizontal" action="XuatExcelDSDV.php">
