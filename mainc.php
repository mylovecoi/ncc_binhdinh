...
<?php
if($madv[3]=="Tỉnh")
						echo "<a href='/Nhap/Nhapmolietsy/molietsynttinh.php?id=1>0'><div class='back face center'>
							<img src='Images/1a.png' style='width: 100%;height: 100%;'/>
						</div></a>";
else if($madv[3]=="Huyện")
echo "<a href='/Nhap/Nhapmolietsy/molietsynthuyen.php?id=1>0'><div class='back face center'>
							<img src='Images/1a.png' style='width: 100%;height: 100%;'/>
						</div></a>";
else if($madv[3]=="Xã")
echo "<a href='/Nhap/Nhapmolietsy/molietsynt.php?id=1>0'><div class='back face center'>
							<img src='Images/1a.png' style='width: 100%;height: 100%;'/>
						</div></a>";
?>
						</div>
...
<?php
if($madv[3]=="Tỉnh")
						echo "<a href='/Nhap/Nhapbhyt/baohiemtinhbg.php?id=1>0'><div class='back face center'>
							<img src='Images/1a.png' style='width: 100%;height: 100%;'/>
						</div></a>";
else if($madv[3]=="Huyện")
echo "<a href='/Nhap/Nhapbhyt/baohiemhuyenbg.php?id=1>0'><div class='back face center'>
							<img src='Images/1a.png' style='width: 100%;height: 100%;'/>
						</div></a>";
else if($madv[3]=="Xã")
echo "<a href='/Nhap/Nhapbhyt/baohiemxabg.php?id=1>0'><div class='back face center'>
							<img src='Images/1a.png' style='width: 100%;height: 100%;'/>
						</div></a>";
?>
						</div>
