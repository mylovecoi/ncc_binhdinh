	...
	<table cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td style="font-weight: bold;text-align: center;">
				<nobr>PHIẾU ĐỐI CHIẾU HỒ SƠ</nobr>
            </td>            
        </tr>
		<tr>
            <td style="font-weight: bold;text-align: center;">
				<nobr>CON ĐẺ NGƯỜI HOẠT ĐỘNG KHÁNG CHIẾN BỊ NHIỄM CĐHH</nobr>
            </td>            
        </tr>
		<tr>
            <td>
				<nobr>Số thứ tự hồ sơ: <?php echo $chuoi[6]; ?></nobr>
            </td>            
        </tr>
	</table>
	<table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
            <td style="text-align: left;">
				<nobr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tỉ lệ suy giảm khả năng lao động: <?php echo $chuoi[7]; ?> </nobr>
            </td>			
        </tr>
		<tr>
            <td style="text-align: left;">
...
<?php
	...
	$sql = "Select * From giaytohhtn where idthannhanhh = ".$chuoi[0]." order by chitiet";
