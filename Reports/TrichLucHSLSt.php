...
<table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:624px;height:985px;">
	...
	$sqltn="select hoten,ngaysinh,quanhe,truquan from thannhanls where idhsls=".$ttdt;
	...
	$sqltc="select hoten,ngaysinh,gioitinh,quanhe,truquan from thannhanls where matrocap='TC-TN-LS-6' and idhsls='$ttdt'";
