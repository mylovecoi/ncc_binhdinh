...
?>
    <table cellspacing="0" cellpadding="0" border="0">
        <tr>
			...
			<?php
				if ($chuoi[11]=="Tỉnh")
					echo "<nobr>".$chuoi[10]."</nobr>";
				else if ($chuoi[11]=="Huyện")
				{					
					echo "<nobr>".$chuoi[10]."</nobr>";
				}
				else if ($chuoi[11]=="Xã")
					echo "<nobr>UBND ".$chuoi[10]."</nobr>";
			?>	
            </td>            
        </tr>
		<tr>
	...
	<table cellspacing="0" cellpadding="0" border="0">
        ...
        <tr>
            <td style="font-weight: bold;text-align: center;">
				<nobr>PHIẾU ĐỐI CHIỀU HỒ SƠ THƯƠNG BINH</nobr>
            </td>            
        </tr>
		<tr>
            <td>
	...
	<table cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
            <td style="text-align: left;">
				<nobr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tỉ lệ suy giảm khả năng lao động: <?php echo $chuoi[8]; ?> </nobr>
            </td>			
        </tr>
		<tr>
            <td style="text-align: left;">
...
<?php
	...
	$sql = "Select * From giaytotb where idhstb = ".$chuoi[0]." order by chitiet";
