...
if (strlen($_GET['id'])<8)
{
	$sql="select * from quatet27 where chuyen='Duyệt' and namqua Like '%".$ahs[1]."%'";
}
else
{
	if ($ahs[2]=="")
		$sql="select * from quatet27 where chuyen='Duyệt' and namqua Like '".$ahs[3]."%' and loaidoituong Like '".$ahs[1]."%' and xa like '".str_replace('_',' ',$ahs[4])."%'";
	else
		$sql="select * from quatet27 where chuyen='Duyệt' and namqua Like '".$ahs[3]."%' and loaidoituong Like '".$ahs[1]."%' and mucqua=".str_replace(',','',str_replace('.','',$ahs[2]))." and xa like '".str_replace('_',' ',$ahs[4])."%'";
}
//echo $sql;
