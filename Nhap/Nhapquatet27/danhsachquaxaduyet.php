...
?>
    <table cellspacing="0" cellpadding="0" border="0">        
		<tr>
			<td style="text-align: left;font-weight: bold;"><nobr>Đơn vị: <?php echo str_replace('_',' ',$tenhuyenin);?></nobr></td>			
		</tr>
	</table>
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td  style='text-align: center;font-weight: bold;'>DANH SÁCH ĐỐI TƯỢNG ĐƯỢC DUYỆT NHẬN QUÀ</td>
		</tr>
		<tr>
...
$stt =0;$sql="";		
	$sql = "Select hoten,diachi,mucqua From quatet27 Where loaidoituong Like '".$loaidoituongin."%' and namqua Like '".$namquain."%' and xa='".$tenhuyenin."' and chuyen='Duyệt'";
