...
$(document).ready(function() {
  $('#trang').change(function() {
		...
		window.location.href="dkquatet27giaiquyet.php?id="+this.value+">0";
  });
 });
</script>
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Danh sách hồ sơ hưởng quà tết, 27/7 được duyệt</h4>
		</div>
...
{
	$sql="select * from quatet27 where chuyen='Duyệt' and huyen='".$madv[0]."' and namqua Like '".$ahs[3]."%' and loaidoituong Like '".$ahs[1]."%' and mucqua=".str_replace(',','',str_replace('.','',$ahs[2]))." and xa like '".$ahs[4]."%'";
}
...
<script type="text/javascript">
	...
	function get_action1() {				
			return "dkquatet27giaiquyet.php?id="+"1>"+$('#namqua').val();			
    }
	function get_action2() {				
			return "dkquatet27giaiquyet.php?id=1>"+$('#namquatao').val();			
    }
	function get_action3() {				
			return "dkquatet27giaiquyet.php?id=1>"+$('#loaidoituongtim').val()+">"+$('#mucquatim').val()+">"+$('#namquatim').val()+">"+$('#xatim').val();			
    }
	function get_action4() {				
			return "danhsachquagq.php";
    }	
</script>
<!------ FOOTER --------->
