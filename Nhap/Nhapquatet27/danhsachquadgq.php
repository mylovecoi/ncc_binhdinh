...
?>
    <table cellspacing="0" cellpadding="0" border="0">        
		...
		<table cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td  style='text-align: center;font-weight: bold;'>DANH SÁCH ĐỐI TƯỢNG ĐANG GIẢI QUYẾT NHẬN QUÀ</td>
		</tr>
		<tr>
...
$stt =0;$sql="";		
	$sql = "Select hoten,diachi,mucqua From quatet27 Where loaidoituong Like '".$loaidoituongin."%' and namqua Like '".$namquain."%' and xa Like '".$xain."%' and chuyen='Chuyển'";
