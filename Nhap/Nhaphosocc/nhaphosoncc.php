...
{		
	window.location.href="/Reports/Phieudoichieucc.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val();	
}	
</script>
...
{	
	if ($madv[3]=="Tỉnh" && $_POST['xahuyen'] != '' && $_POST['hoten'] != "" && $_POST['ngaysinh'] != "" && $_POST['nguyenquan'] != "" && $_POST['truquan'] != "")
	{
		...
		$sqltths="Select max(ttcc) as ttcc From hethongdv where tendonvi='".str_replace('_',' ',$xh[1])."' and tencaptren='".str_replace('_',' ',$xh[0])."'";
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ Người có công giúp đỡ cách mạng <span style = "float:right">Tổng hồ sơ: <?php
			//if ($ahs[2]=="1")
				echo $madv[11];
			//else
				//echo $madv[19];
...
$j = $ahs[0];
	...
	{
		if ($ahs[2]=="1")
			$sql="select * from hosocc Where loaiquatet='1 lần'";
		else if ($ahs[2]=="0")
			$sql="select * from hosocc Where loaiquatet='Hàng tháng'";
		else if ($ahs[2]=="")
			$sql="select * from hosocc";
	}
	else if ($madv[3]=="Huyện")
		$sql="select * from hosocc where huyen='$madv[0]'";
	else if ($madv[3]=="Xã")
		$sql="select * from hosocc where xa='$madv[0]' and huyen='$madv[1]' order by tths";
	//$sql="select * from hosocc";
...
<script type="text/javascript">
    ...
    function get_action() {				
			return "nhaphosoncc.php?id=" + $('#trang').val() + ">" + $('#idhscccs').val();			
    }
