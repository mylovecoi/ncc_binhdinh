...
{		
	window.open("/Reports/Phieudoichieucct.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val());	
}	
</script>
			...
			{  
			   ...
			   { 
					if ($(this).find('td:last').text() == "ncc" && $(this).find('td:nth-child(34)').text() == "")
					{
						...
						$("#tthsdc").val($(this).find('td:nth-child(21)').text());
						$("#xadc").val($(this).find('td:nth-child(22)').text());
						$("#huyendc").val($(this).find('td:nth-child(23)').text());
			...
			{  
			   ...
			   { 
					...
					{						
						...
						$("#idhscccs").val($(this).find('td:nth-child(7)').text());
						...
						$("#danhhieucs").val($(this).find('td:nth-child(11)').text());
						$("#qddhsocs").val($(this).find('td:nth-child(12)').text());
						$("#hoancanhcs").val($(this).find('td:nth-child(13)').text());
						$("#qdtccs").val($(this).find('td:nth-child(14)').text());
						$("#mtckvcs").val($(this).find('td:nth-child(15)').text());
						$("#mtcdbcs").val($(this).find('td:nth-child(16)').text());
	...
	if ($madv[3]=="Tỉnh" && $_POST['hotencs'] != "" && $_POST['ngaysinhcs'] != "" && $_POST['nguyenquancs'] != "" && $_POST['truquancs'] != "")
	{
		...
		// file đính kèm
			...
			{				
				...
				$fileup1 = $_POST['mahotinhcs']."_".$path_parts['filename'].".".$path_parts['extension'];	
		...
		$sqlup = "Update hosocc Set mahobo='".$_POST['mahobocs']."', mahotinh='".$_POST['mahotinhcs']."', hoten='".$_POST['hotencs']."', bidanh='".$_POST['bidanhcs']."', ";
		$sqlup = $sqlup."ngaysinh='".$_POST['ngaysinhcs']."',gioitinh='".$_POST['gioitinhcs']."', nguyenquan='".$_POST['nguyenquancs']."', truquan='".$_POST['truquancs']."', ";
		$sqlup = $sqlup."danhhieu='".$_POST['danhhieucs']."', qddhso='".$_POST['qddhsocs']."', hoancanh='".$_POST['hoancanhcs']."', qdtc='".$_POST['qdtccs']."', ";
		$sqlup = $sqlup."mtckv='".$_POST['mtckvcs']."', mtcdb='".$_POST['mtcdbcs']."', mtcht='".$_POST['mtchtcs']."', ";
		$sqlup = $sqlup."ngaymat='".$_POST['ngaymatcs']."', loaidd='".$_POST['loaiddcs']."', namddlc='".$_POST['namddlccs']."', ";
		$sqlup = $sqlup."soso='".$_POST['sosocs']."', ghichu='".$_POST['ghichucs']."', ";
		...
		$sqlup = $sqlup." where idhscc = ".$_POST['idhscccs'];
		$kq=mysqli_query($con,$sqlup);
		//API
		$hoten = $namsinh = $dantoc= $tongiao = "";
		$maxaAPI = 0;
		$mahuyenAPI = 0;
		$sqltt = "Select hoten,ngaysinh,maxaAPI,mahuyenAPI from hosocc WHERE idhscc = ".$_POST['idhscccs'];
...
{	
	if ($madv[3]=="Tỉnh" && $_POST['xahuyen'] != '' && $_POST['hoten'] != "" && $_POST['ngaysinh'] != "" && $_POST['nguyenquan'] != "" && $_POST['truquan'] != "")
	{
		...
		$sqltths="Select max(ttcc) as ttcc From hethongdv where tendonvi='".$xh[1]."' and tencaptren='".$xh[0]."'";
		...
		$sqlup = "Insert into hosocc Set mahobo='".$_POST['mahobo']."', mahotinh='".$_POST['mahotinh']."', hoten='".$_POST['hoten']."', bidanh='".$_POST['bidanh']."', ";
		$sqlup = $sqlup."ngaysinh='".$_POST['ngaysinh']."',gioitinh='".$_POST['gioitinh']."', nguyenquan='".$_POST['nguyenquan']."', truquan='".$_POST['truquan']."', ";
		$sqlup = $sqlup."danhhieu='".$_POST['danhhieu']."', qddhso='".$_POST['qddhso']."', hoancanh='".$_POST['hoancanh']."', qdtc='".$_POST['qdtc']."', ";
		$sqlup = $sqlup."mtckv='".$_POST['mtckv']."', mtcdb='".$_POST['mtcdb']."', mtcht='".$_POST['mtcht']."', ";
		$sqlup = $sqlup."ngaymat='".$_POST['ngaymat']."', loaidd='".$_POST['loaidd']."', namddlc='".$_POST['namddlc']."', ";
		$sqlup = $sqlup."soso='".$_POST['soso']."', ghichu='".$_POST['ghichu']."', ";
		...
		//echo $sqlup;	
		$kq=mysqli_query($con,$sqlup);
		$sqluptt="Update hethongdv Set ttcc=$sotths,tongcc=tongcc+1 where tendonvi='".str_replace('_',' ',$xh[1])."' and tencaptren='".str_replace('_',' ',$xh[0])."'";
		$kq1=mysqli_query($con,$sqluptt);
		$sqluptt1="Update hethongdv Set tongcc=tongcc+1 where tendonvi='".$madv[0]."' and tencaptren='".$madv[1]."'";
		$kq2=mysqli_query($con,$sqluptt1);
		//API
		$result = mysqli_query($con,"select MAX(idhscc) FROM hosocc");
...
if (isset($_POST["dichuyen"]))
{
	if ($madv[3]=="Tỉnh")
	{
		$sqlup = "Update hosocc Set truquan='".$_POST['noidck']."',ngaydc='".doingay1($_POST['ngaydck'])."',noidc='".$_POST['noidck']."',phanloaidc='".$_POST['phanloaidck']."'";
		if ($_POST['phanloaidck'] == "Chuyển đi nội tỉnh")
		{
			if ($_POST['tenxak'] != "")
			{				
				$xahuyen=explode('-',$_POST['tenxak']);
				$sqltths="Select max(ttcc) as ttcc From hethongdv where tendonvi='".str_replace('_',' ',$xahuyen[1])."' and tencaptren='".str_replace('_',' ',$xahuyen[0])."'";
				$sql1=mysqli_query($con,$sqltths);$sotths=0;	
				while($row=mysqli_fetch_array($sql1)){	
					$sotths=$row['ttcc'];
				}
				$sotths=$sotths+1;
				$sqlup = $sqlup.",xa='".str_replace('_',' ',$xahuyen[1])."',huyen='".str_replace('_',' ',$xahuyen[0])."',tths=$sotths where idhscc=".$_POST['soghidc'];
				$sqluptt="Update hethongdv Set ttcc=$sotths,tongcc=tongcc+1 where tendonvi='".str_replace('_',' ',$xahuyen[1])."' and tencaptren='".str_replace('_',' ',$xahuyen[0])."'";
				$kq1=mysqli_query($con,$sqluptt);
				//$sqluptt1="Update hethongdv Set tongcc=tongcc+1 where tendonvi='".$madv[0]."' and tencaptren='".$madv[1]."'";
				//$kq2=mysqli_query($con,$sqluptt1);
			}
...
if (strrpos($sqlup,"where")<=0)
			$sqlup = $sqlup." where idhscc=".$_POST['soghidc'];
		$kq=mysqli_query($con,$sqlup);
	}
}	
?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ Người có công giúp đỡ cách mạng</h4>
		</div>
...
if(isset($_POST['timkiem'])){
	...
	if ($_POST['tenxatim'] != "")
		$sql="select * from hosocc where xa like '".$huyenxa[1]."%' and huyen like '".$huyenxa[0]."%' and mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%'";
	else
{
if ($madv[3]=="Xã")
		$sql="select * from hosocc where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%' and xa='".$madv[0]."'";
else if ($madv[3]=="Huyện")
$sql="select * from hosocc where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%' and huyen='".$madv[0]."'";
else
$sql="select * from hosocc where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%'";
}
	//echo $sql;
...
else
{
	...
	$huyenxa=explode(' - ',$tenhuyenxa);
	if ($ths[2] != "")
		$sql="select * from hosocc where xa like '".$huyenxa[1]."%' and huyen like '".$huyenxa[0]."%' and mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
	else
{
if ($madv[3]=="Xã")
		$sql="select * from hosocc where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and xa='".$madv[0]."'";
else if ($madv[3]=="Huyện")
$sql="select * from hosocc where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and huyen='".$madv[0]."'";
else
$sql="select * from hosocc where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
}
	$j = $ths[0];
	...
	while($row=mysqli_fetch_array($sql1)){					
		...
		$ls[$cs][8] = $row['bidanh'];
		$ls[$cs][9] = $row['danhhieu'];
		$ls[$cs][10] = $row['qddhso'];
		$ls[$cs][11] = $row['hoancanh'];
		$ls[$cs][12] = $row['qdtc'];
		$ls[$cs][13] = $row['mtckv'];
		$ls[$cs][14] = $row['mtcdb'];
		$ls[$cs][15] = $row['mtcht'];
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>qddhso</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>hoancanh</strong></th>
...
?>				
	...
	<?php		
	/* $ihs = $ahs[1];	
	$sqltn = "Select * From thannhancc Where idhscc = $ihs";	
	$i1 = 0;	
	...
	<?php		
		/* $sqlgt = "Select * From giaytocc Where idhscc = $ihs";	
		$i2 = 0;	
			...
			<div class="modal-body">				
					<form name="thoaimoi" role='form' method='POST' enctype="multipart/form-data" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK1" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Danh hiệu trao tặng:</label>
							<div class="col-sm-7">
								<input name="danhhieu" type="text" class="form-control" id="danhhieu">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Theo quyết định số:</label>
							<div class="col-sm-7">								
								<input name="qddhso" type="text" class="form-control" id="qddhso">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Hoàn cảnh hiện tại:</label>
							<div class="col-sm-10">
								<input name="hoancanh" type="text" class="form-control" id="hoancanh">
							</div>	
			...
			<div class="modal-body">				
					<form name="thoaics" role='form' method='POST' enctype="multipart/form-data" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Danh hiệu trao tặng:</label>
							<div class="col-sm-7">
								<input name="danhhieucs" type="text" class="form-control" id="danhhieucs">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Theo quyết định số:</label>
							<div class="col-sm-7">								
								<input name="qddhsocs" type="text" class="form-control" id="qddhsocs">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Hoàn cảnh hiện tại:</label>
							<div class="col-sm-10">
								<input name="hoancanhcs" type="text" class="form-control" id="hoancanhcs">
							</div>	
							<label for="field-3" class="col-sm-2 control-label">Quyết định trợ cấp:</label>
							<div class="col-sm-2">
							...
							<div class="col-sm-10">
								<input name="idhscccs" type="text" class="form-control" style="display:none" id="idhscccs">
							</div>
						</div>
							<button type="button" class="btn btn-black" data-dismiss="modal">Đóng</button>
					<?php
