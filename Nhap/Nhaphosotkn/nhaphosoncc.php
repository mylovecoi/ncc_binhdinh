...
{		
	window.location.href="/Reports/Phieudoichieutkn.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val();	
}	
</script>
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ Người HĐCM từ ngày 01/01/1945 đến ngày KN tháng Tám năm 1945  <span style = "float:right">Tổng hồ sơ: <?php echo $madv[18];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4>
		</div>
...
$j = $ahs[0];
	...
	if ($madv[3]=="Tỉnh")
		...
		$sql="select * from hosotkn where huyen='$madv[0]'";
	else if ($madv[3]=="Xã")
		$sql="select * from hosotkn where xa='$madv[0]' and huyen='$madv[1]' order by tths";
	//$sql="select * from hosotkn";
...
<script type="text/javascript">
    ...
    function get_action() {				
			return "nhaphosoncc.php?id=" + $('#trang').val() + ">" + $('#idhstkncs').val();			
    }
