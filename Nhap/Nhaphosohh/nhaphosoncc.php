...
<script type="text/javascript" language="javascript" class="init">
			...
			{  
			   ...
			   { 
					if ($(this).find('td:last').text() == "ncc" && $(this).find('td:nth-child(42)').text().indexOf('%') >=0)
					{
...
{		
	if ($madv[3]=="Tỉnh" && $_POST['hotencs'] != "" && $_POST['ngaysinhcs'] != "" && $_POST['nguyenquancs'] != "" && $_POST['truquancs'] != "")
	{
		...
		$sqlup = $sqlup."ngaynhapnghu='".$_POST['ngaynhapnghucs']."', giaytocm='".$_POST['giaytocmcs']."', coquandv='".$_POST['coquandvcs']."', ghichu='".$_POST['ghichucs']."', ngaymat='".$_POST['ngaymatcs']."',gioitinhAPI=$gioitinhAPI";
