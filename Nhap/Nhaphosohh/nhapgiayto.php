...
if(isset($_POST["capnhatts"]))
	{		
		$sqlup = "Update giaytohh Set tengiayto='".$_POST['tengiaytocs']."', chitiet='".$_POST['chitietcs']."', soluong=".kieudouble($_POST['soluongcs']);		
		$sqlup = $sqlup." Where idgiaytohh=".$_POST['idgiaytolscs'];
		//echo $sqlup;	
		$kq=mysqli_query($con,$sqlup);
	}
if(isset($_POST["themmoi"]))
	{		
		$sqlup = "Insert into giaytohh Set tengiayto='".$_POST['tengiayto']."', chitiet='".$_POST['chitiet']."', soluong=".kieudouble($_POST['soluong']);		
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Danh sách giấy tờ hồ sơ hóa học 
	...
	<?php		
		$sqlgt = "Select * From giaytohh Where idhshh = $ihs order by chitiet";	
		$i2 = 0;	
		...
		while($rctgt=@mysqli_fetch_array($qrctgt))
			{	
				...
				echo "<tr>";
					...
					echo "<td style='text-align: left; display:none'>".$rctgt['idgiaytohh']."</td>";
					echo "<td style='text-align: left; display:none'>".$rctgt['idhshh']."</td>";
				echo "</tr>";	
			}		
			echo "</tbody>";
	?>		
