...
{		
	window.open("/Reports/Phieudoichieulst.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val());	
}	
function showAjaxModaltl()
{		
	window.open("/Reports/TrichLucHSLSt.php?id="+$("#soghi").val());	
}
</script>
...
$(document).ready(function() {
  $('#trang').change(function() {
		//alert($('#phanloaitk').val());
		//$('#hsls').load('ajax_lietsy.php?id='+this.value);		
		//$('#thannhan').load('ajax_thannhan.php');
		//$('#giayto').load('ajax_giayto.php');
	  	var phanloaitk = $('#phanloaitk').val();
	  	if(phanloaitk == 'dv')
			window.location.href="nhaphosoncctim.php?id="+this.value+">0>"+$("#donvihisinh").val()+">"+$("#ngayhisinh").val()+">"+$("#thoiky").val()+">"+$("#hoten").val()+">"+$("#huyen").val()+">"+$("#noihisinh").val()+">"+$("#phanloaitk").val();
	  	else if(phanloaitk == 'tn')
	 		window.location.href="nhaphosoncctim.php?id="+this.value+">0>"+$("#hotentim").val()+">"+$("#phanloaitk").val();
		else
...
if (strrpos($sqlup,"where")<=0)
			$sqlup = $sqlup." where idhsls=".$_POST['soghidc'];
		$kq=mysqli_query($con,$sqlup);
	}
}
?>
 ...
 <div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ liệt sĩ</h4>
		</div>
...
if(isset($_POST['timkiemTN'])) {
//echo $_POST['tenxatim'];
	$hshotentim = str_replace("_", " ", $_POST['hotentim']);
	$sql = "select hosols.* from hosols inner join thannhanls on hosols.idhsls=thannhanls.idhsls where thannhanls.hoten = '" . str_replace("_", " ", $_POST['hotentim']) . "'";
	echo "<input name='phanloaitk' type='text' class='form-control' style='display:none' id='phanloaitk' value='tn'>";
	echo "<input name='hotentim' type='text' class='form-control' style='display:none' id='hotentim' value='" . $_POST['hotentim'] . "'>";
	$j = 1;
}
elseif(isset($ths[3]) && $ths[3] == 'tn') {
//echo $_POST['phanloaitk'];
	$hshotentim = str_replace("_", " ", $ths[2]);
	$sql = "select hosols.* from hosols inner join thannhanls on hosols.idhsls=thannhanls.idhsls where thannhanls.hoten = '" . str_replace("_", " ", $ths[2]) . "'";
	echo "<input name='phanloaitk' type='text' class='form-control' style='display:none' id='phanloaitk' value='tn'>";
	echo "<input name='hotentim' type='text' class='form-control' style='display:none' id='hotentim' value='" . $ths[2] . "'>";
        $j = $ths[0];
}
elseif(isset($_POST['timkiemDV'])) {
	$donvihisinh = str_replace("_", " ", $_POST['donvihisinh']);
	$ngayhisinh = $_POST['ngayhisinh'];
	$thoiky = $_POST['thoiky'];
	$hoten =  $_POST['hoten'];
	$huyen =  $_POST['huyen'];
	$noihisinh = $_POST['noihisinh'];

	$sql = "select hosols.* from hosols where donvihisinh like '%" . $donvihisinh . "%'".
		" and ngayhisinh like '%" . $ngayhisinh. "%'".
		($thoiky == 'Chống mỹ'? ' and RIGHT(ngayhisinh, 4) <= 1954 and RIGHT(ngayhisinh, 4) >= 1800 ': ($thoiky == 'Chống pháp'? ' and RIGHT(ngayhisinh, 4) <= 1975 and RIGHT(ngayhisinh, 4) >= 1955 ' : ($thoiky == 'Khác'? ' and RIGHT(ngayhisinh, 4) <= 3000 and RIGHT(ngayhisinh, 4) > 1975 ':($thoiky == 'KXD'? ' and (RIGHT(ngayhisinh, 4) not in (Select RIGHT(ngayhisinh, 4)  from hosols where RIGHT(ngayhisinh, 4) > 1800 and RIGHT(ngayhisinh, 4) < 3000))' :'' )))).
		//" and thoiky like '%" . $thoiky. "%'".
		" and hoten like CONCAT('%', CONVERT('" . $hoten. "', BINARY))  and huyen like '%" . $huyen. "%'".
		" and noihisinh like '%" . $noihisinh. "%'";
	$j = 1;
	echo "<input name='phanloaitk' type='text' class='form-control' style='display:none' id='phanloaitk' value='dv'>";
	echo "<input name='donvihisinh' type='text' class='form-control' style='display:none' id='donvihisinh' value='" . $_POST['donvihisinh'] . "'>";
	echo "<input name='ngayhisinh' type='text' class='form-control' style='display:none' id='ngayhisinh' value='" . $_POST['ngayhisinh'] . "'>";
	echo "<input name='thoiky' type='text' class='form-control' style='display:none' id='thoiky' value='" . $_POST['thoiky'] . "'>";
	echo "<input name='hoten' type='text' class='form-control' style='display:none' id='hoten' value='" . $_POST['hoten'] . "'>";
	echo "<input name='huyen' type='text' class='form-control' style='display:none' id='huyen' value='" . $_POST['huyen'] . "'>";
	echo "<input name='noihisinh' type='text' class='form-control' style='display:none' id='noihisinh' value='" . $_POST['noihisinh'] . "'>";
}
elseif(isset($ths[8]) && $ths[8] == 'dv') {
	$donvihisinh = str_replace("_", " ", $ths[2]);
	$ngayhisinh = $ths[3];
	$thoiky = $ths[4];
	$hoten = $ths[5];
	$huyen = $ths[6];
	...
	$j = $ths[0];
	echo "<input name='phanloaitk' type='text' class='form-control' style='display:none' id='phanloaitk' value='dv'>";
	echo "<input name='donvihisinh' type='text' class='form-control' style='display:none' id='donvihisinh' value='" . $ths[2] . "'>";
	echo "<input name='ngayhisinh' type='text' class='form-control' style='display:none' id='ngayhisinh' value='" . $ths[3] . "'>";
	echo "<input name='thoiky' type='text' class='form-control' style='display:none' id='thoiky' value='" . $ths[4] . "'>";
	echo "<input name='hoten' type='text' class='form-control' style='display:none' id='hoten' value='" . $ths[5] . "'>";
	echo "<input name='huyen' type='text' class='form-control' style='display:none' id='huyen' value='" . $ths[6] . "'>";
	echo "<input name='noihisinh' type='text' class='form-control' style='display:none' id='noihisinh' value='" . $ths[7] . "'>";
}
elseif(isset($_POST['timkiem'])) {
	//echo $_POST['tenxatim'];	
	$tentim = $_POST['tenxatim'];
	$hsbotim = $_POST['mabotim'];
	$hstinhtim = $_POST['matinhtim'];
	$hshotentim = str_replace("_", " ", $_POST['hotentim']);
	$tenhuyenxa = str_replace("_", " ", $_POST['tenxatim']);
	$huyenxa = explode(' - ', $tenhuyenxa);
	if ($_POST['tenxatim'] != "")
		$sql = "select * from hosols where xa like '" . $huyenxa[1] . "%' and huyen like '" . $huyenxa[0] . "%' and mahsbo like '%" . $_POST['mabotim'] . "%' and mahstinh Like '%" . $_POST['matinhtim'] . "%' and hoten Like '%" . str_replace("_", " ", $_POST['hotentim']) . "%'";
	else {
		if ($madv[3] == "Xã")
			$sql = "select * from hosols where mahsbo like '%" . $_POST['mabotim'] . "%' and mahstinh Like '%" . $_POST['matinhtim'] . "%' and hoten Like '%" . str_replace("_", " ", $_POST['hotentim']) . "%' and xa='" . $madv[0] . "'";
		else if ($madv[3] == "Huyện")
			$sql = "select * from hosols where mahsbo like '%" . $_POST['mabotim'] . "%' and mahstinh Like '%" . $_POST['matinhtim'] . "%' and hoten Like '%" . str_replace("_", " ", $_POST['hotentim']) . "%' and huyen='" . $madv[0] . "'";
		else
			$sql = "select * from hosols where mahsbo like '%" . $_POST['mabotim'] . "%' and mahstinh Like '%" . $_POST['matinhtim'] . "%' and hoten Like '%" . str_replace("_", " ", $_POST['hotentim']) . "%'";
	}
	//echo $sql;
...
else
{
	...
	$huyenxa=explode(' - ',$tenhuyenxa);
	if ($ths[2] != "")
		$sql="select * from hosols where xa like '".$huyenxa[1]."%' and huyen like '".$huyenxa[0]."%' and mahsbo like '%".$ths[3]."%' and mahstinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
	else
{
if ($madv[3]=="Xã")
		$sql="select * from hosols where mahsbo like '%".$ths[3]."%' and mahstinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and xa='".$madv[0]."'";
else if ($madv[3]=="Huyện")
$sql="select * from hosols where mahsbo like '%".$ths[3]."%' and mahstinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and huyen='".$madv[0]."'";
else
$sql="select * from hosols where mahsbo like '%".$ths[3]."%' and mahstinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
}
	$j = $ths[0];
	...
	//$sql="select * from hosols where xa='$madv[0]' and huyen='$madv[1]'";
...
?>				
	...
	<div class="modal-header">
		<h4 class="modal-title">Tổng hồ sơ <?php echo $tonghoso;?></h4>
	</div>
</form>
