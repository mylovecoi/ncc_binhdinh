		...
		echo "<table class='table table-hover table-striped table-bordered table-advanced tablesorter display' id='table-2'>";
			echo "<thead>";
				echo "<tr>";
					...
					echo "<th style='background-color:rgb(54, 169, 224); display:none' width='12%'><strong style='color:rgb(255, 255, 225)'>phanloai</strong></th>";
	...
	{	
		...
		for($i=0;$i<=$count-1;$i++)
		{
			...
			echo "<tr>";
				...
				echo "<td style='text-align: left; color:#0F0F10'>$kytu1[0]</td>";				
				echo "<td style='color:#0F0F10'>$kytu1[1]</td>";
				echo "<td style='color:#0F0F10'>".$kytu1[2]."</td>";
				echo "<td contenteditable=true style='color:#0F0F10'>$kytu1[3]</td>";
				echo "<td style='color:#0F0F10; display:none'>$kytu1[4]</td>";
