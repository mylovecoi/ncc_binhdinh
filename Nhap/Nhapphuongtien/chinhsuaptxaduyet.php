...
$j = 1;//$ahs[0];
	...
	{ */
		$sql="select * from phuongtien where chuyen='Duyệt' and xa='".$madv[0]."'";
	//}
	//echo $sql;
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(54, 169, 224); display:none" width="8%"><strong style='color:rgb(255, 255, 225)'>Đơn vị</strong></th>
		...
		<div class="modal-content">				
			<div class="modal-body">				
					<form name="thoaimoi" role='form' method='POST' class='form-horizontal form-groups-bordered'>
						...
						<h3><strong>Chi tiết phương tiện, công cụ:</strong></h3>
