...
function kieudouble($so)
{
		...
		echo "<table class='table table-hover table-striped table-bordered table-advanced tablesorter display' id='table-2'>";
			echo "<thead>";
				echo "<tr>";
					...
					echo "<th style='background-color:rgb(54, 169, 224)' width='12%'><strong style='color:rgb(255, 255, 225)'>Ngày trả</strong></th>";
	...
	while($row=mysqli_fetch_array($sql1)){
		$dkxoa=$row['idctpt']."<".$row['tenphuongtien']."<".$row['nienhan']."<".$row['sotien']."<".$row['ngaycap']."<".$row['phanloai'];
		$i = $i + 1;
			echo "<tr>";
				...
				echo "<td contenteditable=true style='color:#0F0F10'>".$row['ngaycap']."</td>";
