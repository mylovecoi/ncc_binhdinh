...
if(isset($_POST["capnhat"]))
{
	...
	$sqlpt = $sqlpt."tinhtrangsk='".$_POST['tinhtrangsk']."', lydo='".$_POST['lydo']."', xa='".str_replace('_',' ',$_POST['tenxatao'])."', huyen='".$madv[0]."', chuyen='Chuyển 1', sosoql='".$_POST['sosoql']."', noiql='".$_POST['noiql']."'";
	$kqpt=mysqli_query($con,$sqlpt);
	$sql = "Select max(idphuongtien) as idpt from phuongtien where xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";
