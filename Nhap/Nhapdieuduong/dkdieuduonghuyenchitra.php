...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Danh sách hồ sơ điều dưỡng đã duyệt</h4>
		</div>
...
{
	$sql="select * from dieuduong where chuyen='Duyệt' and huyen='".$madv[0]."'";
	if ($ahs[2] != "")
...
{
	$sql="select * from dieuduong where chuyen='Duyệt' and huyen='".$madv[0]."' order by xa";
}
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(54, 169, 224)" width="40%"><strong style='color:rgb(255, 255, 225)'><p>Đối tượng</p></strong></th>
					...
					<div id = "sTTKK1" class="form-group">
						...
						<div class="col-sm-9">
							<select name="tenxatao" id="tenxatao" class="form-control">
								<option value="" selected = "selected"></option>
								<?php
								$sqltcml = "Select tenxa From xa INNER JOIN huyen on xa.mahuyen = huyen.mahuyen where huyen.tenhuyen = '$madv[0]'";
								$qrtcml = mysqli_query($con,$sqltcml);
								while($rtcml=@mysqli_fetch_array($qrtcml))
								{
						...
						<div class="col-sm-12">
							<input type="checkbox" name="ah" id="ah" checked = "checked" value="Yes" />
							Anh hung lực lượng vũ trang, anh hung lao động trong thời kỳ kháng chiến
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="lt" id="lt" checked = "checked" value="Yes" />
							Người hoạt động cách mạng trước 01 tháng 01 năm 1945
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="tkn" id="tkn" checked = "checked" value="Yes" />
							Người hoạt động cách mạng từ ngày 01 tháng 01 năm 1945 đến ngày khởi nghĩa tháng tám năm 1945
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="bm" id="bm" checked = "checked"  />
							Bà mẹ Việt Nam anh hùng
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="tb" id="tb" checked = "checked"  />
							Thương binh và người hưởng chính sách như thương binh
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="bb" id="bb" checked = "checked"  />
							Bệnh binh
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="hh" id="hh" checked = "checked" value="Yes" />
							Người hoạt động kháng chiến nhiễm chất độc hóa học
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="tnls" id="tnls" checked = "checked" value="Yes" />
							Thân nhân Liệt sỹ
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="kctd" id="kctd" checked = "checked" value="Yes" />
							Người hoạt động kháng chiến bị địch bắt, tù đày
						</div>
						<div class="col-sm-12">
							<input type="checkbox" name="cc" id="cc" checked = "checked" value="Yes" />
...
<script type="text/javascript">
	...
	function get_action2() {
		...
		giatri="1>"+$('#namdd').val()+">"+$('#tb').val()+">"+b2+">"+b3+">"+b4+">"+b5+">"+b6+">"+b7+">"+b8+">"+b9+">"+b10+">"+$('#tenhuyentao').val()+">"+$('#tenxatao').val();
		return "dkdieuduonghuyenchitra.php?id="+giatri;
	}
</script>
<!------ FOOTER --------->
