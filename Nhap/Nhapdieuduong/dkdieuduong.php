			...
			<div class="modal-body">
				<form role='form' method='POST' class='form-horizontal form-groups-bordered'>
					<a style = "float:right; background-color:rgb(83, 181, 166)" onclick="showAjaxModaldc();" class='btn btn-success'>
						<i class='entypo-plus'></i>Lập danh sách
					</a>
...
<div class="modal-content">
	<div class="modal-header">
		<h4 class="modal-title">Danh sách chuyển lên cấp trên</h4>
	</div>
	<div id = "" >
		<table class="table table-bordered datatable" >
			...
			<?php
			$sql = "Select distinct ngaychuyenhuyen,namdd from dieuduong WHERE ngaychuyenhuyen <> '0000-00-00' and chuyenhuyen = 'Đã chuyển' or chuyenhuyen = 'Chuyển tỉnh'".
				" and xa = '".$madv[0]."'";
			//echo $sql;
