...
if (isset($_POST["taobhyt"]))
{
	...
	if (isset($_POST['tb']))
	{
		...
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Thương binh')";
	...
	if (isset($_POST['bb']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Bệnh binh')";
		$kq=mysqli_query($con,$sql);
	}
	//anh hùng
	if (isset($_POST['ah']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Anh hùng')";
		$kq=mysqli_query($con,$sql);
	}
	//Bà mẹ
	if (isset($_POST['bm']))
	...
	if (isset($_POST['lt']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Người hoạt động trước 01/01/1945')";
		$kq=mysqli_query($con,$sql);
	}
	//Tiền khởi nghĩa
	if (isset($_POST['tkn']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Tiền khởi nghĩa')";
		$kq=mysqli_query($con,$sql);
	}
	...
	if (isset($_POST['hh']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Người nhiễm chất độc hóa học')";
		$kq=mysqli_query($con,$sql);
	}
	//Bị bắt tù đày
	if (isset($_POST['kctd']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Tù đày'')";
		$kq=mysqli_query($con,$sql);
	}
	//thân nhân liệt sỹ
	if (isset($_POST['tnls']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Thân nhân liệt sỹ')";
		$kq=mysqli_query($con,$sql);
	}
	...
	if (isset($_POST['cc']))
	{
		...
		$sql = $sql . " and ((loaidd = 'Hai năm một lần' and namddlc = $nam2) or (loaidd = 'Một năm một lần' and namddlc = $nam1))";
		$sql = $sql . " and idhsbm not in (Select idhs from dieuduong where namdd = $namdd and doituong = 'Người có công giúp đỡ cách mạng')";
		$kq=mysqli_query($con,$sql);
	}
}
...
<?php
	...
	$cs=0;$sql="";
	$sql="select * from dieuduong where chuyen='Duyệt' and xa = '$madv[0]' and huyen='".$madv[1]."' and namdd = '$nam'";
