...
{
	$sqlpt = "Insert into thutuchc Set phanloai='Người có công', hoten='".$_POST['hoten']."', ngaysinh='".$_POST['ngaysinh']."', ";
	$sqlpt = $sqlpt."gioitinh='".$_POST['gioitinh']."', nguyenquan='".$_POST['nguyenquan']."', truquan='".$_POST['truquan']."', noidung='".$_POST['noidung']."', ";
	$sqlpt = $sqlpt."loaidoituong='".$_POST['loaidoituong']."', trangthai='Chuyển 1', xa='".str_replace('_',' ',$_POST['xa'])."', huyen='".$madv[0]."', ngaylaphs='".doingay1($_POST['ngaylaphs'])."', phanloaihoso='".$_POST['phanloaihoso']."'";
...
<form name = "thoainhap" role='form' method='POST' onsubmit="return kt()" class='form-horizontal form-groups-bordered'>
	...
	<label for="field-3" class="col-sm-2 control-label">Đối tượng<span style="padding-left:0px; color:red;">*</span>:</label>
	<div class="col-sm-4">
	...
	<label for="field-3" class="col-sm-2 control-label">Tên đơn vị<span style="padding-left:0px; color:red;">*</span>:</label>
	<div class="col-sm-10">								
...
function kt()
{
   ...
   if(frm.hoten.value=='' || frm.ngaysinh.value=='' || frm.gioitinh.value=='' || frm.loaidoituong.value=='' || frm.ngaylaphs.value=='' || frm.phanloaihoso.value=='' || frm.xa.value=='')
   {
