...
$(document).ready(function() {
  $('#loaidoituong').change(function() {		
		$('#danhsach').load('ajax_danhsachxa.php?id_a=' + $('#loaidoituong').val() + '>' + $('#donvi').val());
  });
 });
</script>

<form name = "thoainhap" role='form' class='form-horizontal form-groups-bordered'>
	<input name="donvi" type="text" style="display:none" class="form-control" id="donvi" value="<?php echo str_replace(' ','_',$madv[0]); ?>">	
...
<?php	
			$i=0;
			$sql="select idhsah as idhs,hoten,ngaysinh,truquan from hosoah where xa='".$madv[0]."'";
