			   ...
			   { 
					...
					{	
						...
						else
						{
							...
							//alert($(this).find('td:nth-child(28)').text());
							if ($(this).find('td:nth-child(28)').text()=="0000-00-00")															
								$("#ngayqdx").val("");
							else
...
$(document).ready(function() {
  $('#trang').change(function() {
		...
		window.location.href="danhsachthutucchitra.php?id="+this.value+">0";
  });
 });
//
...
if(isset($_POST["capnhat"]))
{
	...
	{
		$sqlpt = "Update thutuchc Set ngaytraqd='".doingay1($_POST['ngaytraqd'])."', noitraqd='".$_POST['noitraqd']."', captraoqd='x'";
...
if(isset($_POST["capnhatx"]))
{
	...
	{
		$sqlpt = "Update thutuchc Set ngaytraqd='".doingay1($_POST['ngaytraqdx'])."', noitraqd='".$_POST['noitraqdx']."', captraoqd='x'";
...
$j = $ahs;
	...
	$cs=0;
	$sql="select * from thutuchc where xa='".$madv[0]."' and huyen='".$madv[1]."' and trangthai='Duyệt'";
...
<div class="modal fade" id="modal-5">
	<div class="modal-dialog">
		<div class="modal-content">				
			<div class="modal-body">				
					<form name="thoaitao" role='form' method='POST' action="/Thoaikx/Danhsachhosotrakq.php" class='form-horizontal form-groups-bordered'>
