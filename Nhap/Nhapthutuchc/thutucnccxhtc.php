...
if(isset($_POST["capnhat"]))
{
	...
	$sqlpt = $sqlpt."loaidoituong='".$_POST['loaidoituong']."', trangthai='DK', xa='".$madv[0]."', huyen='".$madv[1]."', ngaylaphs='".doingay1($_POST['ngaylaphs'])."', phanloaihoso='".$_POST['phanloaihoso']."'";
...
function kt()
{
   ...
   if(frm.hoten.value=='' || frm.ngaysinh.value=='' || frm.gioitinh.value=='' || frm.loaidoituong.value=='' || frm.ngaylaphs.value=='' || frm.phanloaihoso.value=='')
   {
