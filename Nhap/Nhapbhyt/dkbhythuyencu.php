...
if(isset($_POST["themmoi"]))
	{	
		...
		$sqlup = $sqlup.", xa='".str_replace('_',' ',$_POST['tenxa'])."', huyen='".$madv[0]."', xacnhan='Chuyển 1', thang=".$_POST['thang'].", nam=".$_POST['nam'];
		$kq=mysqli_query($con,$sqlup);
	}
if (isset($_POST["taobhyt"]))
{
	...
	if (isset($_POST['tb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosotb Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		//echo $sql;
	...
	if (isset($_POST['tntb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhantb Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//bệnh binh
	if (isset($_POST['bb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosobb Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnbb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanbb Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//anh hùng
	if (isset($_POST['ah']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosoah Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnah']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanah Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//Bà mẹ
	if (isset($_POST['bm']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosobm Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnbm']))
	{
		$sql = "Insert into ".ktnam($_POST['nambh'])."(hoten,ngaysinh,gioitinh,truquan,loaidt,phanloai,sotien,thtu,thden,mandk,noidk,xa,huyen,xacnhan,thang,nam)";
		$sql = $sql." Select hoten,ngaysinh,gioitinh,truquan,'Thân nhân của bà mẹ' as loai,'Cấp mới' as ploai,'".$_POST['sotienbh'];
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanbm Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	...
	if (isset($_POST['lt']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosolt Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnlt']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanlt Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//Tiền khởi nghĩa
	if (isset($_POST['tkn']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosotkn Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tntkn']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhantkn Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	...
	if (isset($_POST['hh']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosohh Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnhh']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanhh Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//Bị bắt tù đày
	if (isset($_POST['kctd']))
	{
		$sql = "Insert into ".ktnam($_POST['nambh'])."(hoten,ngaysinh,gioitinh,truquan,loaidt,phanloai,sotien,thtu,thden,mandk,noidk,xa,huyen,xacnhan,thang,nam)";
		$sql = $sql." Select hoten,ngaysinh,gioitinh,truquan,'Người bị địch bắt tù đày' as loai,'Cấp mới' as ploai,'".$_POST['sotienbh'];
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosotd Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//thân nhân liệt sỹ
	if (isset($_POST['tn']))
	{
		$sql = "Insert into ".ktnam($_POST['nambh'])."(hoten,ngaysinh,gioitinh,truquan,loaidt,phanloai,sotien,thtu,thden,mandk,noidk,xa,huyen,xacnhan,thang,nam)";
		$sql = $sql." Select hoten,ngaysinh,gioitinh,truquan,'Thân nhân của liệt sỹ' as loai,'Cấp mới' as ploai,'".$_POST['sotienbh'];
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanhh Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	...
	if (isset($_POST['cc']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosocc Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	...
	if (isset($_POST['hdkc']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".str_replace('_',' ',$_POST['tenxatao'])."' as xa,'".$madv[0]."' as huyen,'Chuyển 1' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosokc Where bhyt='Có' and xa='".str_replace('_',' ',$_POST['tenxatao'])."' and huyen='".$madv[0]."'";		
		$kq=mysqli_query($con,$sql);		
	}	
}
...
{	
	...
	for($i=0;$i<$count;$i++){
		$nbh=explode('<',$key[$i]);
	$sql="Update ".ktnam($nbh[1])." Set xacnhan='Chuyển 2' Where idbhyt=".$nbh[0];
	$kq=mysqli_query($con,$sql);
	}
}	
?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Đăng ký bảo hiểm y tế </h4>
		</div>
...
<form role='form' method='POST' class='form-horizontal form-groups-bordered'>						
		...
		<a style = "float:right; background-color:rgb(83, 181, 166)" onclick="showAjaxModaldc();" class='btn btn-success'>
			<i class='entypo-print'></i>Tạo đăng ký
		</a>
...
$j = $ahs[0];
	...
	$cs=0;
	$sql="select * from ".ktnam(date('Y'))." where xacnhan='Chuyển 1' and huyen='".$madv[0]."'";
		...
		<div class="modal-content">				
			<div class="modal-body">				
					<form name="thoaitao" role='form' method='POST' class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK1" class="form-group">	
							<label for="field-3" class="col-sm-3 control-label">Tháng đăng ký bảo hiểm:</label>
							<div class="col-sm-3">
								<input name="thangbh" type="text" class="form-control" id="thangbh">
							</div>
							<label for="field-3" class="col-sm-3 control-label">Năm đăng ký bảo hiểm:</label>
							<div class="col-sm-3">
								<input name="nambh" type="text" class="form-control" id="nambh">
							</div>
							<label for="field-3" class="col-sm-3 control-label">Số tiền đóng bảo hiểm:</label>
							<div class="col-sm-9">
								<input name="sotienbh" type="text" class="form-control" data-mask="fdecimal" id="sotienbh">
							</div>
							<label for="field-3" class="col-sm-3 control-label">Thời hạn thẻ từ:</label>							
							<div class="col-sm-3">
								<input name="thbhtu" type="text" class="form-control" data-mask="date" id="thbhtu">
							</div>
							<label for="field-3" class="col-sm-3 control-label">Thời hạn thẻ đến:</label>							
							<div class="col-sm-3">
		...
		<div class="modal-content">
			<div class="modal-body">				
					<form name="thoaichuyen" role='form' method='POST' enctype="multipart/form-data" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK" class="form-group">
							<h4 style = "text-align:center; color:rgb(10, 10, 10)">CHUYỂN DANH SÁCH ĐĂNG KÝ BHYT LÊN CẤP TRÊN</h4>	
