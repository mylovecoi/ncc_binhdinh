...
{
	$sql="select * from ".ktnam(date('Y'))." where xacnhan='Chuyển 2' and xa like '%".str_replace('_',' ',$ahs[21])."%' and huyen Like '%".str_replace('_',' ',$ahs[20])."%'";
	if ($ahs[2] != "")
		$dkkhac="loaidt='".$ahs[2]."'";
	if ($ahs[3] != "")
	{
...
{
	$sql="select * from ".ktnam(date('Y'))." where xacnhan='Chuyển 2'";
}
