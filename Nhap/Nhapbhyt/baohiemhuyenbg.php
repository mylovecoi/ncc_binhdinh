		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(54, 169, 224)" width="6%"><strong style='color:rgb(255, 255, 225)'><p>Đối tượng</p></strong></th>
					...
					<th style="background-color:rgb(54, 169, 224)" width="6%"><strong style='color:rgb(255, 255, 225)'><p>Chi tiết đối tượng</p></strong></th>
					...
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>idbh</strong></th>
					<th style="background-color:rgb(54, 169, 224)" width="7%"><strong style='color:rgb(255, 255, 225)'><p>Đơn vị</p></strong></th>
				</tr>				
			</thead>
			...
			<div class="modal-body">				
					<form name="thoaimoi" role='form' method='POST' class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK1" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Ngày cấp thẻ:</label>
							<div class="col-sm-4">
							...
							<label for="field-3" class="col-sm-2 control-label">Lý do tăng giảm:</label>
							<div class="col-sm-10">
