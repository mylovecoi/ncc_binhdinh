...
$(document).ready(function() {
  $('#trang').change(function() {
		...
		window.location.href="dkbhyttheodoi.php?id="+this.value+">0";
  });
 });
</script>
...
$j = $ahs[0];
	...
	$cs=0;
	$sql="select * from ".ktnam(date('Y'))." where (xacnhan='DK' or xacnhan='Chuyển 1' or xacnhan='Chuyển 2') and xa='".$madv[0]."' and huyen='".$madv[1]."' and (mathe='' or mathe is null)";
