...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Xác nhận cấp thẻ bảo hiểm y tế </h4>
		</div>
...
$j = $ahs[0];
	...
	$cs=0;
	$sql="select * from ".ktnam(date('Y'))." where xacnhan='Duyệt' and xa='".$madv[0]."' and huyen='".$madv[1]."' and (mathe='' or mathe is null)";
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(54, 169, 224)" width="56%"><strong style='color:rgb(255, 255, 225)'>Nơi đăng ký khám bệnh</strong></th>
