...
$(document).ready(function() {
  $('#trang').change(function() {
		window.location.href="baohiemxabg.php?id="+this.value+">"+$("#stxx").val()+">"+$("#nguoiccxx").val()+">"+$("#thannhanxx").val()+">"+$("#doituongxx").val()+">";
  });
 });		
</script>
<?php
...
{
	/* $sqlup = "Update baohiem Set nguoicc='".$_POST['nguoicccs']."', doituong='".$_POST['doituongcs']."', quanhe='".$_POST['quanhecs']."', ";//thannhan='".$_POST['thannhancs']."', quanhe='".$_POST['quanhecs']."', ";
...
{
	/* $sqlup = "Insert into baohiem Set nguoicc='".$_POST['nguoicc']."', doituong='".$_POST['doituong']."', quanhe='".$_POST['quanhe']."', ";//thannhan='".$_POST['thannhan']."', quanhe='".$_POST['quanhe']."', ";
...
if ($ahs[5] == 'timkiem')
{	
	$sql="select * from baohiem where nguoicc like '%".$ahs[2]."%' and thannhan like '%".$ahs[3]."%' and doituong Like '%".$ahs[4]."%' and xa='".$madv[0]."'";	
...
{
	$sql="select * from baohiem where xa='".$madv[0]."' LIMIT ".(15*($j-1)).",15";
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(54, 169, 224)" width="15%"><strong style='color:rgb(255, 255, 225)'><p>Người có công</p></strong></th>					
					<th style="background-color:rgb(54, 169, 224)" width="27%"><strong style='color:rgb(255, 255, 225)'><p>Đối tượng</p></strong></th>
					...
					<th style="background-color:rgb(54, 169, 224)" width="6%"><strong style='color:rgb(255, 255, 225)'><p>Mã thẻ</p></strong></th>					
					<th style="background-color:rgb(54, 169, 224)" width="20%"><strong style='color:rgb(255, 255, 225)'><p>Chi tiết đối tượng</p></strong></th>
			...
			<div class="modal-body">				
					<form name="thoaimoi" role='form' method='POST' class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK1" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Chi tiết đối tượng:</label>
							<div class="col-sm-10">
								<input name="tanggiam" type="text" class="form-control" id="tanggiam">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Mã cơ sở kb:</label>
							<div class="col-sm-10">
...
<div class="modal fade" id="modal-2">
	<div class="modal-dialog">
		<div class="modal-content">				
			<div class="modal-body">				
					<form name="thoaiin" role='form' method='POST' action="reportbhytxabg.php" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK1" class="form-group">
							<label for="field-3" class="col-sm-3 control-label">Đối tượng:</label>
							<div class="col-sm-9">								
...
<script type="text/javascript">
    ...
    function get_action() {				
			return "baohiemxabg.php?id=1>"+$("#stxx").val();			
    }
	function get_action1() {				
			return "baohiemxabg.php?id=1>"+$("#stxx").val();
	}
	function get_action2() {				
			return "baohiemxabg.php?id=1>"+$("#stxx").val()+">"+$('#nguoicctim').val()+">"+$('#thannhantim').val()+">"+$('#doituongtim').val()+">timkiem";		
    }
</script>
<!------ FOOTER --------->
