...
function showinds()
{		
	window.location.href="/Thoaikx/Dsdangkybhyt.php?id="+$("#xadc").val()+">"+$("#huyendc").val();
}
</script>
<script type="text/javascript" language="javascript" class="init">
			$(document).ready(function() 
...
if(isset($_POST["capnhatts"]))
	{	
		$noidkbhyt="";
		$sqlbh = "Select tnkb From danhmuckb where mankb='".$_POST['mandkcs']."'";
		...
		$sqlup = $sqlup.", thden='".$_POST['thdencs']."', sotien='".$_POST['sotiencs']."', phanloai='".$_POST['phanloaics']."', loaidt='".$_POST['loaidtcs']."', thang=".$_POST['thangcs'].", nam=".$_POST['namcs'].", noidk='".$noidkbhyt."'";
...
if(isset($_POST["themmoi"]))
	{
		$noidkbhyt="";
		$sqlbh = "Select tnkb From danhmuckb where mankb='".$_POST['mandk']."'";
		$sqlbh1=mysqli_query($con,$sqlbh);
		while($rowbh=mysqli_fetch_array($sqlbh1)){
		$noidkbhyt = $rowbh['tnkb'];
		}
		...
		$sqlup = $sqlup.", xa='".$madv[0]."', huyen='".$madv[1]."', xacnhan='DK', thang=".$_POST['thang'].", nam=".$_POST['nam'].", noidk='".$noidkbhyt."'";
		$kq=mysqli_query($con,$sqlup);
	}
if (isset($_POST["taobhyt"]))
{
	...
	if (isset($_POST['tb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosotb Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
	...
	if (isset($_POST['tntb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhantb Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//bệnh binh
	if (isset($_POST['bb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosobb Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnbb']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanbb Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//anh hùng
	if (isset($_POST['ah']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosoah Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnah']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanah Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//Bà mẹ
	if (isset($_POST['bm']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosobm Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnbm']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanbm Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	...
	if (isset($_POST['lt']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosolt Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnlt']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanlt Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//Tiền khởi nghĩa
	if (isset($_POST['tkn']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosotkn Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tntkn']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhantkn Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	...
	if (isset($_POST['hh']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosohh Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	if (isset($_POST['tnhh']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from thannhanhh Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//Bị bắt tù đày
	if (isset($_POST['kctd']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosotd Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	//thân nhân liệt sỹ
	if (isset($_POST['tn']))
	...
	if (isset($_POST['cc']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosocc Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}
	...
	if (isset($_POST['hdkc']))
	{
		...
		$sql = $sql."' as stien,'".$_POST['thbhtu']."' as tu,'".$_POST['thbhden']."' as den,'".$_POST['noidkbh']."' as noi,'".$noidkbhyt."' as n,'".$madv[0]."' as xa,'".$madv[1]."' as huyen,'DK' as xn,".$_POST['thangbh']." as thangbh,".$_POST['nambh']." as nambh from hosokc Where bhyt='Có' and xa='".$madv[0]."' and huyen='".$madv[1]."'";		
		$kq=mysqli_query($con,$sql);		
	}	
}
...
{	
	...
	for($i=0;$i<$count;$i++){
		$nbh=explode('<',$key[$i]);
	$sql="Update ".ktnam($nbh[1])." Set xacnhan='Chuyển 1' Where xa='".$madv[0]."' and huyen='".$madv[1]."' and idbhyt=".$nbh[0];
	$kq=mysqli_query($con,$sql);
	}
}	
?>
...
<form role='form' method='POST' class='form-horizontal form-groups-bordered'>						
		...
		<input name="huyendc" type="text" class="form-control" style="display:none" id="huyendc"  value = "<?php echo $madv[1];?>">
		<label class='col-sm-2'>Trang số:</label>
<?php
//echo date('Y');
//$sql="select * from ".ktnam(date('Y'))." where xacnhan='DK' and xa='".$madv[0]."' and huyen='".$madv[1]."'";
	//echo $sql;
$ahs = explode('>',$_GET['id']);
$j = $ahs[0];
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(54, 169, 224)" width="49%"><strong style='color:rgb(255, 255, 225)'>Nơi đăng ký khám bệnh</strong></th>
...
<?php
			...
			for($i=($j - 1)*15;$i<15*$j;$i++)
			{
				...
				echo "<tr>";					
					...
					echo"<td>					
							<a href=\"xoa.php?id=".$ls[$i][17].'<'.$ls[$i][19]."\"  title='Xóa hố sơ bảo hiểm y tế' onclick=\"return confirm('Bạn muốn xóa hố sơ này?')\" class='btn btn-red '>
								</i>
								Xóa
							</a>
						</td>";
...
<script type="text/javascript">
	...
	function get_action2() {				
			return "dkbhyt.php?id="+$('#trangm').val()+">2016";			
    }
