...
{	
	if ($madv[3]=="Tỉnh")
	{	
		$sqlup = "Update giaytoah Set tengiayto='".$_POST['tengiaytocs']."', chitiet='".$_POST['chitietcs']."', soluong=".kieudouble($_POST['soluongcs']);		
		$sqlup = $sqlup." Where idgiaytoah=".$_POST['idgiaytotkncs'];
		//echo $sqlup;	
...
if(isset($_POST["themmoi"]))
{
	if ($madv[3]=="Tỉnh")
	{
		$sqlup = "Insert into giaytoah Set tengiayto='".$_POST['tengiayto']."', chitiet='".$_POST['chitiet']."', soluong=".kieudouble($_POST['soluong']);		
		$sqlup = $sqlup.", idhsah=".$ihs;
		//echo $sqlup;	
		$kq=mysqli_query($con,$sqlup);
	}
}	
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Danh sách giấy tờ hồ sơ anh hùng 
	...
	<?php		
		$sqlgt = "Select * From giaytoah Where idhsah = $ihs order by chitiet";	
		$i2 = 0;	
		...
		while($rctgt=@mysqli_fetch_array($qrctgt))
			{	
				...
				echo "<tr>";
					...
					echo "<td style='text-align: left; display:none'>".$rctgt['idgiaytoah']."</td>";
					echo "<td style='text-align: left; display:none'>".$rctgt['idhsah']."</td>";
				echo "</tr>";	
			}		
			echo "</tbody>";
	?>		
