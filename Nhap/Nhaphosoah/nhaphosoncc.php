...
{		
	window.location.href="/Reports/Phieudoichieuah.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val();	
}	
</script>
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ anh hùng LĐ,LLVT <span style = "float:right">Tổng hồ sơ: <?php echo $madv[8];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4>
		</div>
...
$j = $ahs[0];
	...
	if ($madv[3]=="Tỉnh")
		...
		$sql="select * from hosoah where huyen='$madv[0]'";
	else if ($madv[3]=="Xã")
		$sql="select * from hosoah where xa='$madv[0]' and huyen='$madv[1]' order by tths";
	//$sql="select * from hosoah";
...
<script type="text/javascript">
    ...
    function get_action() {			
			return "nhaphosoncc.php?id=" + $('#trang').val() + ">" + $('#idhsahcs').val();			
    }
