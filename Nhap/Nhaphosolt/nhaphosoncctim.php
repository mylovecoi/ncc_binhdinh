...
{		
	window.open("/Reports/Phieudoichieultt.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val());	
}	
</script>
	...
	if ($madv[3]=="Tỉnh")
	{
		...
		if ($_POST['phanloaidck'] == "Chuyển đi nội tỉnh")
		{
			...
			{				
				...
				$sqluptt="Update hethongdv Set ttlt=$sotths,tonglt=tonglt+1 where tendonvi='".str_replace('_',' ',$xahuyen[1])."' and tencaptren='".str_replace('_',' ',$xahuyen[0])."'";
				$kq1=mysqli_query($con,$sqluptt);
				//$sqluptt1="Update hethongdv Set tonglt=tonglt+1 where tendonvi='".$madv[0]."' and tencaptren='".$madv[1]."'";
				//$kq2=mysqli_query($con,$sqluptt1);
			}
...
if (strrpos($sqlup,"where")<=0)
			$sqlup = $sqlup." where idhslt=".$_POST['soghidc'];
		$kq=mysqli_query($con,$sqlup);
	}
}	
?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ Người HĐCM trước ngày 01 tháng 01 năm 1945</h4>
		</div>
...
if(isset($_POST['timkiem'])){
	...
	if ($_POST['tenxatim'] != "")
		$sql="select * from hosolt where xa like '".$huyenxa[1]."%' and huyen like '".$huyenxa[0]."%' and mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%'";
	else
{
if ($madv[3]=="Xã")
		$sql="select * from hosolt where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%' and xa='".$madv[0]."'";
else if ($madv[3]=="Huyện")
$sql="select * from hosolt where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%' and huyen='".$madv[0]."'";
else
$sql="select * from hosolt where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%'";
}
	//echo $sql;
...
else
{
	...
	$huyenxa=explode(' - ',$tenhuyenxa);
	if ($ths[2] != "")
		$sql="select * from hosolt where xa like '".$huyenxa[1]."%' and huyen like '".$huyenxa[0]."%' and mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
	else
{
if ($madv[3]=="Xã")
		$sql="select * from hosolt where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and xa='".$madv[0]."'";
else if ($madv[3]=="Huyện")
$sql="select * from hosolt where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and huyen='".$madv[0]."'";
else
$sql="select * from hosolt where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
}
	$j = $ths[0];
