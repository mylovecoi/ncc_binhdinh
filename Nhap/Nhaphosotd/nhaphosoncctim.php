...
{		
	window.open("/Reports/Phieudoichieutdt.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val());	
}	
</script>
...
<script type="text/javascript" language="javascript" class="init">
			...
			{  
			   ...
			   { 
					if ($(this).find('td:last').text() == "ncc" && $(this).find('td:nth-child(33)').text() == "")
					{
						...
						$("#xadc").val($(this).find('td:nth-child(21)').text());
						$("#huyendc").val($(this).find('td:nth-child(22)').text());
						...
						$("#xaAPI").val($(this).find('td:nth-child(33)').text());
			...
			{  
			   ...
			   { 
					...
					{						
						...
						$("#idhstdcs").val($(this).find('td:nth-child(7)').text());
						...
						$("#qdtcmlcs").val($(this).find('td:nth-child(11)').text());
						$("#muctccs").val($(this).find('td:nth-child(12)').text());
						$("#qdtchtcs").val($(this).find('td:nth-child(13)').text());
						$("#mtckvcs").val($(this).find('td:nth-child(14)').text());
						$("#mtcdbcs").val($(this).find('td:nth-child(15)').text());
						$("#mtchtcs").val($(this).find('td:nth-child(16)').text());
						$("#ngaymatcs").val($(this).find('td:nth-child(17)').text());
						$("#ghichucs").val($(this).find('td:nth-child(18)').text());						
						$("#sosocs").val($(this).find('td:nth-child(19)').text());
						$("#loaidd").val($(this).find('td:nth-child(23)').text());
						$("#namddlccs").val($(this).find('td:nth-child(24)').text());
						$("#filea").val($(this).find('td:nth-child(25)').text());	
						$("#dieuduongcs").val($(this).find('td:nth-child(26)').text());
						$("#hinhthucddltcs").val($(this).find('td:nth-child(27)').text());
						$("#bhytcs").val($(this).find('td:nth-child(28)').text());	
if ($(this).find('td:nth-child(29)').text()=="0000-00-00")	
	$("#ngaydccs").val("");
else
	$("#ngaydccs").val(ngaythang($(this).find('td:nth-child(29)').text()));
$("#noidccs").val($(this).find('td:nth-child(30)').text());
$("#phanloaidccs").val($(this).find('td:nth-child(31)').text());						
						document.getElementById("dd").src = $(this).find('td:nth-child(25)').text();
						var ddfile=$(this).find('td:nth-child(32)').text().lastIndexOf('/');
document.getElementById("duongdan").href = "download.php?id=/data/upload"+$(this).find('td:nth-child(32)').text().substr(ddfile);
						if ($(this).find('td:nth-child(32)').text()=="")
...
{	
	if ($madv[3]=="Tỉnh" && $_POST['hotencs'] != "" && $_POST['ngaysinhcs'] != "" && $_POST['nguyenquancs'] != "" && $_POST['truquancs'] != "")
	{
		...
		$sqlup = "Update hosotd Set mahobo='".$_POST['mahobocs']."', mahotinh='".$_POST['mahotinhcs']."', hoten='".$_POST['hotencs']."', bidanh='".$_POST['bidanhcs']."', ";
		$sqlup = $sqlup."ngaysinh='".$_POST['ngaysinhcs']."',gioitinh='".$_POST['gioitinhcs']."', nguyenquan='".$_POST['nguyenquancs']."', truquan='".$_POST['truquancs']."', ";
		$sqlup = $sqlup."qdtcml='".$_POST['qdtcmlcs']."', muctc='".$_POST['muctccs']."', qdtcht='".$_POST['qdtchtcs']."', mtckv='".$_POST['mtckvcs']."', ";
		$sqlup = $sqlup."mtcdb='".$_POST['mtcdbcs']."', mtcht='".$_POST['mtchtcs']."', ngaymat='".$_POST['ngaymatcs']."', ";
		$sqlup = $sqlup."ghichu='".$_POST['ghichucs']."', loaidd='".$_POST['loaiddcs']."', namddlc='".$_POST['namddlccs']."', ";
		$sqlup = $sqlup."soso='".$_POST['sosocs']."', dieuduong='".$_POST['dieuduongcs']."', hinhthucddlt='".$_POST['hinhthucddltcs']."', bhyt='".$_POST['bhytcs']."', ";
		...
		$sqlup = $sqlup." where idhstd = ".$_POST['idhstdcs'];
		$kq=mysqli_query($con,$sqlup);
		//API
		$hoten = $namsinh = $dantoc= $tongiao = "";
		$maxaAPI = 0;
		$mahuyenAPI = 0;
		$sqltt = "Select hoten,ngaysinh,maxaAPI,mahuyenAPI from hosotd WHERE idhstd = ".$_POST['idhstdcs'];
...
{	
	if ($madv[3]=="Tỉnh" && $_POST['xahuyen'] != '' && $_POST['hoten'] != "" && $_POST['ngaysinh'] != "" && $_POST['nguyenquan'] != "" && $_POST['truquan'] != "")
	{
		...
		$sqltths="Select max(tttd) as tttd From hethongdv where tendonvi='".str_replace('_',' ',$xh[1])."' and tencaptren='".str_replace('_',' ',$xh[0])."'";
		...
		$sqlup = "Insert into hosotd Set mahobo='".$_POST['mahobo']."', mahotinh='".$_POST['mahotinh']."', hoten='".$_POST['hoten']."', bidanh='".$_POST['bidanh']."', ";
		$sqlup = $sqlup."ngaysinh='".$_POST['ngaysinh']."',gioitinh='".$_POST['gioitinh']."', nguyenquan='".$_POST['nguyenquan']."', truquan='".$_POST['truquan']."', ";
		$sqlup = $sqlup."qdtcml='".$_POST['qdtcml']."', muctc='".$_POST['muctc']."', qdtcht='".$_POST['qdtcht']."', mtckv='".$_POST['mtckv']."', ";
		$sqlup = $sqlup."mtcdb='".$_POST['mtcdb']."', mtcht='".$_POST['mtcht']."', ngaymat='".$_POST['ngaymat']."', ";
		$sqlup = $sqlup."ghichu='".$_POST['ghichu']."', loaidd='".$_POST['loaidd']."', namddlc='".$_POST['namddlc']."', ";
		$sqlup = $sqlup."soso='".$_POST['soso']."', dieuduong='".$_POST['dieuduong']."', hinhthucddlt='".$_POST['hinhthucddlt']."', bhyt='".$_POST['bhyt']."', ";
		...
		//echo $sqlup;	
		$kq=mysqli_query($con,$sqlup);
		$sqluptt="Update hethongdv Set tttd=$sotths,tongtd=tongtd+1 where tendonvi='".str_replace('_',' ',$xh[1])."' and tencaptren='".str_replace('_',' ',$xh[0])."'";
		$kq1=mysqli_query($con,$sqluptt);
		$sqluptt1="Update hethongdv Set tongtd=tongtd+1 where tendonvi='".$madv[0]."' and tencaptren='".$madv[1]."'";
		$kq2=mysqli_query($con,$sqluptt1);
		//API
		$result = mysqli_query($con,"select MAX(idhstd) FROM hosotd");
...
if (isset($_POST["dichuyen"]))
{
	if ($madv[3]=="Tỉnh")
	{
		$sqlup = "Update hosotd Set truquan='".$_POST['noidck']."',ngaydc='".doingay1($_POST['ngaydck'])."',noidc='".$_POST['noidck']."',phanloaidc='".$_POST['phanloaidck']."'";
		if ($_POST['phanloaidck'] == "Chuyển đi nội tỉnh")
		{
			if ($_POST['tenxak'] != "")
			{				
				$xahuyen=explode('-',$_POST['tenxak']);
				$sqltths="Select max(tttd) as tttd From hethongdv where tendonvi='".str_replace('_',' ',$xahuyen[1])."' and tencaptren='".str_replace('_',' ',$xahuyen[0])."'";
				$sql1=mysqli_query($con,$sqltths);$sotths=0;	
				while($row=mysqli_fetch_array($sql1)){	
					$sotths=$row['tttd'];
				}
				$sotths=$sotths+1;
				$sqlup = $sqlup.",xa='".str_replace('_',' ',$xahuyen[1])."',huyen='".str_replace('_',' ',$xahuyen[0])."',tths=$sotths where idhstd=".$_POST['soghidc'];
				$sqluptt="Update hethongdv Set tttd=$sotths,tongtd=tongtd+1 where tendonvi='".str_replace('_',' ',$xahuyen[1])."' and tencaptren='".str_replace('_',' ',$xahuyen[0])."'";
				$kq1=mysqli_query($con,$sqluptt);
				//$sqluptt1="Update hethongdv Set tongtd=tongtd+1 where tendonvi='".$madv[0]."' and tencaptren='".$madv[1]."'";
				//$kq2=mysqli_query($con,$sqluptt1);
			}
...
if (strrpos($sqlup,"where")<=0)
			$sqlup = $sqlup." where idhstd=".$_POST['soghidc'];
		$kq=mysqli_query($con,$sqlup);
	}
}	
?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ người HĐKC bị địch bắt, tù đày</h4>
		</div>
...
if(isset($_POST['timkiem'])){
	...
	if ($_POST['tenxatim'] != "")
		$sql="select * from hosotd where xa like '".$huyenxa[1]."%' and huyen like '".$huyenxa[0]."%' and mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%'";
	else
{
if ($madv[3]=="Xã")
		$sql="select * from hosotd where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%' and xa='".$madv[0]."'";
else if ($madv[3]=="Huyện")
$sql="select * from hosotd where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%' and huyen='".$madv[0]."'";
else
$sql="select * from hosotd where mahobo like '%".$_POST['mabotim']."%' and mahotinh Like '%".$_POST['matinhtim']."%' and hoten Like '%".str_replace("_"," ",$_POST['hotentim'])."%'";
}
	//echo $sql;
...
else
{
	...
	$huyenxa=explode(' - ',$tenhuyenxa);
	if ($ths[2] != "")
		$sql="select * from hosotd where xa like '".$huyenxa[1]."%' and huyen like '".$huyenxa[0]."%' and mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
	else
{
if ($madv[3]=="Xã")
		$sql="select * from hosotd where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and xa='".$madv[0]."'";
else if ($madv[3]=="Huyện")
$sql="select * from hosotd where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%' and huyen='".$madv[0]."'";
else
$sql="select * from hosotd where mahobo like '%".$ths[3]."%' and mahotinh Like '%".$ths[4]."%' and hoten Like '%".str_replace("_"," ",$ths[5])."%'";
}
	//echo $sql;
	$j = $ths[0];
	...
	while($row=mysqli_fetch_array($sql1)){					
		...
		$ls[$cs][23] = $row['filea'];
		$ls[$cs][24] = $row['dieuduong'];
		$ls[$cs][25] = $row['hinhthucddlt'];
		$ls[$cs][26] = $row['bhyt'];
		$ls[$cs][27] = $row['ngaydc'];
		$ls[$cs][28] = $row['noidc'];
		$ls[$cs][29] = $row['phanloaidc'];	
		$ls[$cs][30] = $row['filedk'];
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>muctc</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>qdtcht</strong></th>
...
?>				
	...
	<?php		
	/* $ihs = $ahs[1];	
	$sqltn = "Select * From thannhantd Where idhstd = $ihs";	
	$i1 = 0;	
	...
	<?php		
		/* $sqlgt = "Select * From giaytotd Where idhstd = $ihs";	
		$i2 = 0;	
			...
			<div class="modal-body">				
					<form name="thoaimoi" role='form' method='POST' enctype="multipart/form-data" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK1" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Mức trợ cấp một lần:</label>
							<div class="col-sm-7">
								<input name="muctc" type="text" class="form-control" data-mask="fdecimal" id="muctc">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Quyết định tcht:</label>
							<div class="col-sm-2">
								<input name="qdtcht" type="text" class="form-control" id="qdtcht">
							</div>		
							...
							<input name="trangm" type="text" class="form-control" style="display:none" id="trangm" value = "1">
						</div>
			...
			<div class="modal-body">				
					<form name="thoaics" role='form' method='POST' enctype="multipart/form-data" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Mức trợ cấp một lần:</label>
							<div class="col-sm-7">	
								<input name="muctccs" type="text" class="form-control" data-mask="fdecimal" id="muctccs">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Quyết định tcht:</label>
							<div class="col-sm-2">
								<input name="qdtchtcs" type="text" class="form-control" id="qdtchtcs">
							</div>		
							<label for="field-3" class="col-sm-2 control-label">Trợ cấp khu vực:</label>
							<div class="col-sm-6">
							...
							<div class="col-sm-10">
								<input name="idhstdcs" type="text" class="form-control" style="display:none" id="idhstdcs">
							</div>
						</div>
							<button type="button" class="btn btn-black" data-dismiss="modal">Đóng</button>
					<?php	
