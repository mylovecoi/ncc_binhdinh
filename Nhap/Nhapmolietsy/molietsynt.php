...
$(document).ready(function() {
  $('#trang').change(function() {
		...
		window.location.href="molietsynt.php?id="+this.value+">0";
  });
 });		
</script>
<?php
...
<form role='form' method='POST' class='form-horizontal form-groups-bordered'>		
		...
		<input name="xain" type="text" class="form-control" style="display:none" id="xain" value = "<?php echo $madv[0];?>">
		<input name="huyenin" type="text" class="form-control" style="display:none" id="huyenin" value = "<?php echo $madv[1];?>">
...
$j = $ahs[0];
	...
	$cs=0;
	$sql="select * from molietsy where xa='".$madv[0]."' and huyen='".$madv[1]."'";
...
<script type="text/javascript">
    ...
    function get_action() {				
			return "molietsynt.php?id=" + $('#trang').val() + ">" + $('#idmolscs').val();			
    }
	function get_action1() {				
			return "molietsynt.php?id="+$('#trangm').val()+">0";			
    }
</script>
<!------ FOOTER --------->
