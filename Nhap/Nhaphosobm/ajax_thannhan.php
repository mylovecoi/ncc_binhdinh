		...
		echo "<table class='table table-hover table-striped table-bordered table-advanced tablesorter display' id='table-3'>";
			echo "<thead>";
				echo "<tr>";
					...
					echo "<th style='background-color:rgb(54, 169, 224)' width='30%'><strong style='color:rgb(255, 255, 225)'>Phân loại</strong></th>";						
				echo "</tr>";				
			echo "</thead>";
	$idhsls = $_GET['id_a'];
	$sql = "Select * From thannhanbm Where idhsbm = $idhsls";	
	$i = 0;
	//echo $sql;
		...
		{	
			$i = $i + 1;
				echo "<tr>";
					...
					echo "<td style='text-align: left;'>".$rct['phanloaitbls']."</td>";
				echo "</tr>";
		}		
			echo "</tbody>";
		echo "</table>";
