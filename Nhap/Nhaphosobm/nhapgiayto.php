...
if(isset($_POST["capnhatts"]))
	{		
		$sqlup = "Update giaytobm Set tengiayto='".$_POST['tengiaytocs']."', chitiet='".$_POST['chitietcs']."', soluong=".$_POST['soluongcs'];		
		$sqlup = $sqlup." Where idgiaytobm=".$_POST['idgiaytotkncs'];
		//echo $sqlup;	
		$kq=mysqli_query($con,$sqlup);
	}
if(isset($_POST["themmoi"]))
	{		
		$sqlup = "Insert into giaytobm Set tengiayto='".$_POST['tengiayto']."', chitiet='".$_POST['chitiet']."', soluong=".$_POST['soluong'];		
		$sqlup = $sqlup.", idhsbm=".$ihs;
		//echo $sqlup;	
		$kq=mysqli_query($con,$sqlup);
	}	
?>
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Danh sách giấy tờ hồ sơ bà mẹ anh hùng 
	...
	<?php		
		$sqlgt = "Select * From giaytobm Where idhsbm = $ihs order by chitiet";	
		$i2 = 0;	
		...
		while($rctgt=@mysqli_fetch_array($qrctgt))
			{	
				...
				echo "<tr>";
					...
					echo "<td style='text-align: left; display:none'>".$rctgt['idgiaytobm']."</td>";
					echo "<td style='text-align: left; display:none'>".$rctgt['idhsbm']."</td>";
				echo "</tr>";	
			}		
			echo "</tbody>";
	?>		
