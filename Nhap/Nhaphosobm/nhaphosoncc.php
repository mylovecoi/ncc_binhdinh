...
{		
	window.location.href="/Reports/Phieudoichieubm.php?id="+$("#soghi").val()+">"+$("#hotendc").val()+">"+$("#ngaysinhdc").val()+">"+$("#nguyenquandc").val()+">"+$("#truquandc").val()+">"+$("#mahsbodc").val()+">"+$("#mahstinhdc").val()+">"+$("#tthsdc").val()+">"+$("#tendv").val()+">"+$("#tenct").val()+">"+$("#quanly").val();	
}	
</script>
...
<script type="text/javascript" language="javascript" class="init">
			...
			{  
			   ...
			   { 
					if ($(this).find('td:last').text() == "ncc" && $(this).find('td:nth-child(37)').text() == "")
					{
						//alert($(this).find('td:nth-child(31)').text());
						...
						$("#tthsdc").val($(this).find('td:nth-child(12)').text());
						$("#xadc").val($(this).find('td:nth-child(18)').text());
						$("#huyendc").val($(this).find('td:nth-child(19)').text());
						...
						$("#huyenAPI").val($(this).find('td:nth-child(34)').text());
					}
else
{
	//alert($(this).find('td:nth-child(34)').text());
$("#soghidc").val($(this).find('td:nth-child(7)').text());
						$("#soghi").val($(this).find('td:nth-child(7)').text());
						$("#hotendc").val($(this).find('td:nth-child(2)').text());
						$("#ngaysinhdc").val($(this).find('td:nth-child(3)').text());
			...
			{  
			   ...
			   { 
					...
					{						
						...
						$("#idhsbmcs").val($(this).find('td:nth-child(7)').text());
						...
						$("#soquyetdinhcs").val($(this).find('td:nth-child(11)').text());						
						$("#mtckvcs").val($(this).find('td:nth-child(13)').text());
						$("#mtcdbcs").val($(this).find('td:nth-child(14)').text());
						$("#mtchtcs").val($(this).find('td:nth-child(15)').text());
						$("#ngaymatcs").val($(this).find('td:nth-child(16)').text());
						$("#sosocs").val($(this).find('td:nth-child(17)').text());
						$("#ghichucs").val($(this).find('td:nth-child(20)').text());						
						$("#loaiddcs").val($(this).find('td:nth-child(21)').text());
						$("#namddlccs").val($(this).find('td:nth-child(22)').text());
						$("#fileanhcu").val($(this).find('td:nth-child(23)').text());	
						$("#dieuduongcs").val($(this).find('td:nth-child(24)').text());
						$("#hinhthucddltcs").val($(this).find('td:nth-child(25)').text());
						$("#bhytcs").val($(this).find('td:nth-child(26)').text());
						$("#dantoccs").val($(this).find('td:nth-child(31)').text());
						$("#tongiaocs").val($(this).find('td:nth-child(32)').text());
						$("#tinhhinhhncs").val($(this).find('td:nth-child(33)').text());
						if ($(this).find('td:nth-child(27)').text()=="0000-00-00")
							$("#ngaydccs").val("");
						else
							$("#ngaydccs").val(ngaythang($(this).find('td:nth-child(27)').text()));
$("#noidccs").val($(this).find('td:nth-child(28)').text());
$("#phanloaidccs").val($(this).find('td:nth-child(29)').text());
						document.getElementById("dd").src = $(this).find('td:nth-child(23)').text();
						//document.getElementById("duongdan").href = "download.php?id="+$(this).find('td:nth-child(30)').text();
						var ddfile=$(this).find('td:nth-child(30)').text().lastIndexOf('/');
						document.getElementById("duongdan").href = "download.php?id=/data/upload"+$(this).find('td:nth-child(30)').text().substr(ddfile);
						if ($(this).find('td:nth-child(30)').text()=="")
...
{	
	if ($madv[3]=="Tỉnh" && $_POST['hotencs'] != "" && $_POST['ngaysinhcs'] != "" && $_POST['nguyenquancs'] != "" && $_POST['truquancs'] != "") {
		...
		// insert
		$sqlup = "Update hosobm Set mahobo='" . $_POST['mahobocs'] . "', mahotinh='" . $_POST['mahotinhcs'] . "', hoten='" . $_POST['hotencs'] . "', dantoc='" . $_POST['dantoccs'] . "', ";
		$sqlup = $sqlup . "ngaysinh='" . $_POST['ngaysinhcs'] . "', nguyenquan='" . $_POST['nguyenquancs'] . "', truquan='" . $_POST['truquancs'] . "', ";
		$sqlup = $sqlup . "soquyetdinh='" . $_POST['soquyetdinhcs'] . "', mtckv='" . $_POST['mtckvcs'] . "', mtcdb='" . $_POST['mtcdbcs'] . "', mtcht='" . $_POST['mtchtcs'] . "', ";
		$sqlup = $sqlup . "ngaymat='" . $_POST['ngaymatcs'] . "', soso='" . $_POST['sosocs'] . "', ghichu='" . $_POST['ghichucs'] . "', ";
		$sqlup = $sqlup . "loaidd='" . $_POST['loaiddcs'] . "', namddlc='" . $_POST['namddlccs'] . "', tongiao='" . $_POST['tongiaocs'] . "',tinhhinhhn='" . $_POST['tinhhinhhncs'] . "', ";
		...
		$sqlup = $sqlup . " where idhsbm = " . $_POST['idhsbmcs'];
		$kq = mysqli_query($con, $sqlup);
		$hoten = $namsinh = $dantoc = $tongiao = "";
		$maxaAPI = 0;
		$mahuyenAPI = 0;
		$sqltt = "Select hoten,dantoc,ngaysinh,tongiao,maxaAPI,mahuyenAPI from hosobm WHERE idhsbm = " . $_POST['idhsbmcs'];
...
{	
	if ($madv[3]=="Tỉnh" && $_POST['xahuyen'] != '' && $_POST['hoten'] != "" && $_POST['ngaysinh'] != "" && $_POST['nguyenquan'] != "" && $_POST['truquan'] != "")
	{
		...
		$sqltths="Select max(ttbm) as ttbm From hethongdv where tendonvi='".str_replace('_',' ',$xh[1])."' and tencaptren='".str_replace('_',' ',$xh[0])."'";
		...
		// insert
		$sqlup = "Insert into hosobm Set mahobo='".$_POST['mahobo']."', mahotinh='".$_POST['mahotinh']."', hoten='".$_POST['hoten']."', dantoc='".$_POST['dantoc']."', ";
		$sqlup = $sqlup."ngaysinh='".$_POST['ngaysinh']."', nguyenquan='".$_POST['nguyenquan']."', truquan='".$_POST['truquan']."', ";
		$sqlup = $sqlup."soquyetdinh='".$_POST['soquyetdinh']."', mtckv='".$_POST['mtckv']."', mtcdb='".$_POST['mtcdb']."', mtcht='".$_POST['mtcht']."', ";
		$sqlup = $sqlup."ngaymat='".$_POST['ngaymat']."', soso='".$_POST['soso']."', ghichu='".$_POST['ghichu']."', ";
		$sqlup = $sqlup."loaidd='".$_POST['loaidd']."', namddlc='".$_POST['namddlc']."', tongiao='".$_POST['tongiao']."',tinhhinhhn='".$_POST['tinhhinhhn']."',";
		...
		$sqlup = $sqlup.", maxaAPI='".str_replace('_',' ',$xh[2])."', mahuyenAPI='".str_replace('_',' ',$xh[3])."'";
		if ($fileanh != "")
			$sqlup = $sqlup.", filea='".$fileanh."'";
		if ($filedkurl1 != "")
			$sqlup = $sqlup.", filedk='".$filedkurl1."'";		
		$kq=mysqli_query($con,$sqlup);
		$sqluptt="Update hethongdv Set ttbm=$sotths,tongbm=tongbm+1 where tendonvi='".str_replace('_',' ',$xh[1])."' and tencaptren='".str_replace('_',' ',$xh[0])."'";
		$kq1=mysqli_query($con,$sqluptt);
		$sqluptt1="Update hethongdv Set tongbm=tongbm+1 where tendonvi='".$madv[0]."' and tencaptren='".$madv[1]."'";
		$kq2=mysqli_query($con,$sqluptt1);
		$result = mysqli_query($con,"select MAX(idhsbm) FROM hosobm");
		while ($row = mysqli_fetch_array($result)){
			$highest_id = $row[0];
		}
		$dantoc= $tongiao = "";
		if ($_POST['dantoc'] != "Kinh")
			$dantoc = "0";
		else
			$dantoc = "01";
		$tongiao = "00";
...
if (isset($_POST["dichuyen"]))
{
	if ($madv[3]=="Tỉnh")
	{
		$sqlup = "Update hosobm Set truquan='".$_POST['noidck']."',ngaydc='".doingay1($_POST['ngaydck'])."',noidc='".$_POST['noidck']."',phanloaidc='".$_POST['phanloaidck']."'";
		if ($_POST['phanloaidck'] == "Chuyển đi nội tỉnh")
		{
			if ($_POST['tenxak'] != "")
			{				
				$xahuyen=explode('-',$_POST['tenxak']);
				$sqltths="Select max(ttbm) as ttbm From hethongdv where tendonvi='".str_replace('_',' ',$xahuyen[1])."' and tencaptren='".str_replace('_',' ',$xahuyen[0])."'";
				$sql1=mysqli_query($con,$sqltths);$sotths=0;	
				while($row=mysqli_fetch_array($sql1)){	
					$sotths=$row['ttbm'];
				}
				$sotths=$sotths+1;
				$sqlup = $sqlup.",xa='".str_replace('_',' ',$xahuyen[1])."',huyen='".str_replace('_',' ',$xahuyen[0])."',tths=$sotths, maxaAPI = $xahuyen[2],mahuyenAPI = $xahuyen[3] where idhsbm=".$_POST['soghidc'];
				$sqluptt="Update hethongdv Set ttbm=$sotths,tongbm=tongbm+1 where tendonvi='".str_replace('_',' ',$xahuyen[1])."' and tencaptren='".str_replace('_',' ',$xahuyen[0])."'";
				$kq1=mysqli_query($con,$sqluptt);
				//$sqluptt1="Update hethongdv Set tongbm=tongbm+1 where tendonvi='".$madv[0]."' and tencaptren='".$madv[1]."'";
				//$kq2=mysqli_query($con,$sqluptt1);
			}
...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<h4 class="modal-title">Hồ sơ bà mẹ Việt Nam anh hùng <span style = "float:right">Tổng hồ sơ: <?php echo $madv[10];?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></h4>
		</div>
...
<?php
$ahs = explode('>',$_GET['id']);
$j = $ahs[0];$kq=0;$sotr=0;$sotr= (int)($madv[10]/5);$sotrthieu=$madv[10]/5;
		if ($sotrthieu-$sotr >0)
	$sotr=$sotr+1;
$sotr=$sotr+1;
	...
	$cs=0;
	if ($madv[3]=="Tỉnh")
		$sql="select * from hosobm LIMIT ".(5*($j-1)).",5";
	else if ($madv[3]=="Huyện")
		$sql="select * from hosobm where huyen='$madv[0]' LIMIT ".(5*($j-1)).",5";
	else if ($madv[3]=="Xã")
		$sql="select * from hosobm where xa='$madv[0]' and huyen='$madv[1]' LIMIT ".(5*($j-1)).",5";	
	...
	while($row=mysqli_fetch_array($sql1)){					
		...
		$ls[$cs][2] = $row['nguyenquan'];
		$ls[$cs][3] = $row['truquan'];
		$ls[$cs][4] = $row['idhsbm'];
		$ls[$cs][5] = $row['mahobo'];
		$ls[$cs][6] = $row['mahotinh'];
		$ls[$cs][7] = $row['bidanh'];
		$ls[$cs][8] = $row['soquyetdinh'];
		$ls[$cs][9] = $row['tths'];
		$ls[$cs][10] = $row['mtckv'];
		$ls[$cs][11] = $row['mtcdb'];
		$ls[$cs][12] = $row['mtcht'];
		$ls[$cs][13] = $row['ngaymat'];
		$ls[$cs][14] = $row['soso'];
		$ls[$cs][15] = $row['xa'];
		$ls[$cs][16] = $row['huyen'];
		$ls[$cs][17] = $row['ghichu'];		
		$ls[$cs][18] = $row['loaidd'];
		$ls[$cs][19] = $row['namddlc'];		
		$ls[$cs][20] = $row['filea'];
		$ls[$cs][21] = $row['dieuduong'];
		$ls[$cs][22] = $row['hinhthucddlt'];
		$ls[$cs][23] = $row['bhyt'];
		$ls[$cs][24] = $row['ngaydc'];
		$ls[$cs][25] = $row['noidc'];
		$ls[$cs][26] = $row['phanloaidc'];	
		$ls[$cs][27] = $row['filedk'];
		$ls[$cs][28] = $row['dantoc'];
		$ls[$cs][29] = $row['tongiao'];
		$ls[$cs][30] = $row['tinhhinhhn'];
		$ls[$cs][31] = $row['maxaAPI'];
		$ls[$cs][32] = $row['mahuyenAPI'];
		$cs = $cs + 1;
	/* $kq=$kq + 1;
	if ($kq == 5)
	{
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-2">
			<thead>
				<tr>					
					...
					<th style="background-color:rgb(54, 169, 224); display:none" width="6%"><strong style='color:rgb(255, 255, 225)'>Giới tính</strong></th>
					...
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>idhsbm</strong></th>
					...
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>soquyetdinh</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>tths</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>mtckv</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>mtcdb</strong></th>
					...
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>bhyt</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>bhyt</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>dantoc</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>tongiao</strong></th>
					<th style="background-color:rgb(16, 78, 211); display:none" width="30%"><strong>tinhhinhhn</strong></th>
	...
	return $kq;
			...
			for($i=0;$i<$cs;$i++)
			{
				...
				echo "<tr>";					
					...
					echo "<td>".$ls[$i][1]."</td>";
					echo "<td style='text-align: left; display:none'></td>";
					echo "<td style='text-align: left;'>".catchuoi($ls[$i][2])."</td>";
					...
					{
						echo"<td>					
							<a href=\"xoa.php?id=".$ls[$i][4]."\"  title='Xóa hố sơ và thông tin liên quan' onclick=\"return confirm('Bạn muốn xóa hố sơ này?')\" class='btn btn-red '>
								</i>
								Xóa
							</a>
						</td>";
...
?>				
		...
		<table class="table table-hover table-striped table-bordered table-advanced tablesorter display" id="table-3">
			<thead>
				<tr>
					...
					<th style="background-color:rgb(54, 169, 224)" width="45%"><strong style='color:rgb(255, 255, 225)'>Phân loại</strong></th>						
				</tr>				
			</thead>
	<?php		
	$ihs = $ahs[1];	
	$sqltn = "Select * From thannhanbm Where idhsbm = $ihs";	
	$i1 = 0;	
		...
		{	
			$i1 = $i1 + 1;
				echo "<tr>";
					...
					echo "<td style='text-align: left;'>".$rcttn['phanloaitbls']."</td>";
				echo "</tr>";
		}		
			echo "</tbody>";
	?>		
	...
	<?php		
		$sqlgt = "Select * From giaytobm Where idhsbm = $ihs";	
		$i2 = 0;	
			...
			<div class="modal-body">				
					<form name="thoaimoi" role='form' method='POST' enctype="multipart/form-data" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK1" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Dân tộc:</label>
							<div class="col-sm-3">
								<input name="dantoc" type="text" class="form-control" id="dantoc">
							</div>	
							<label for="field-3" class="col-sm-2 control-label">Tôn giáo:</label>
							<div class="col-sm-2">
								<input name="tongiao" type="text" class="form-control" id="tongiao">
							</div>	
							...
							<label for="field-3" class="col-sm-2 control-label">Tình hình hiện nay:</label>
							<div class="col-sm-7">
								<input name="tinhhinhhn" type="text" class="form-control" id="tinhhinhhn">
							</div>	
							<label for="field-3" class="col-sm-2 control-label">Quyết định số:</label>
							<div class="col-sm-7">
								<input name="soquyetdinh" type="text" class="form-control" id="soquyetdinh">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Loại trợ cấp:</label>
							<div class="col-sm-10">
								<select name="noidungcs" id="noidungcs" class="form-control">
									<?php
									$sql = "select DISTINCT tentrocap from dmtrocap where matrocap like 'BMVN%'";
							...
							<label for="field-3" class="col-sm-2 control-label">Trợ cấp phục vụ:</label>
							<div class="col-sm-2">	
								<input name="mtckv" type="text" class="form-control" data-mask="fdecimal" id="mtckv">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Phụ cấp đặc biệt:</label>
							<div class="col-sm-6">
								<input name="mtcdb" type="text" class="form-control" data-mask="fdecimal" id="mtcdb">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Phụ cấp hàng tháng:</label>
							<div class="col-sm-10">
			...
			<div class="modal-body">				
					<form name="thoaics" role='form' method='POST' enctype="multipart/form-data" class='form-horizontal form-groups-bordered'>
						<div id = "sTTKK" class="form-group">
							...
							<label for="field-3" class="col-sm-2 control-label">Dân tộc:</label>
							<div class="col-sm-3">
								<input name="dantoccs" type="text" class="form-control" id="dantoccs">
							</div>	
							<label for="field-3" class="col-sm-2 control-label">Tôn giáo:</label>
							<div class="col-sm-2">
								<input name="tongiaocs" type="text" class="form-control" id="tongiaocs">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Nguyên quán<span style="padding-left:0px; color:red;">*</span>:</label>
							<div class="col-sm-7">
							...
							<label for="field-3" class="col-sm-2 control-label">Tình hình hiện nay:</label>
							<div class="col-sm-7">
								<input name="tinhhinhhncs" type="text" class="form-control" id="tinhhinhhncs">
							</div>							
							<label for="field-3" class="col-sm-2 control-label">Quyết định số:</label>
							<div class="col-sm-7">
								<input name="soquyetdinhcs" type="text" class="form-control" id="soquyetdinhcs">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Loại trợ cấp:</label>
							<div class="col-sm-10">
								<select name="noidungcs" id="noidungcs" class="form-control">
							...
							<label for="field-3" class="col-sm-2 control-label">Trợ cấp phục vụ:</label>
							<div class="col-sm-2">	
								<input name="mtckvcs" type="text" class="form-control" data-mask="fdecimal" id="mtckvcs">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Phụ cấp đặc biệt:</label>
							<div class="col-sm-6">	
								<input name="mtcdbcs" type="text" class="form-control" data-mask="fdecimal" id="mtcdbcs">
							</div>
							<label for="field-3" class="col-sm-2 control-label">Phụ cấp hàng tháng:</label>
							<div class="col-sm-10">	
							...
							<div class="col-sm-10">
								<input name="idhsbmcs" type="text" class="form-control" style="display:none" id="idhsbmcs">
							</div>
						</div>
							<button type="button" class="btn btn-black" data-dismiss="modal">Đóng</button>
					<?php	
...
<script type="text/javascript">
    ...
    function get_action() {				
			return "nhaphosoncc.php?id=" + $('#trang').val() + ">" + $('#idhsbmcs').val();			
    }
