...
{	
	if ($madv[3]=="Tỉnh" && $_POST['hotencs'] != "" && $_POST['ngaysinhcs'] != "" && $_POST['quequancs'] != "" && $_POST['truquancs'] != "")
	{
		...
		$sqlup = $sqlup."donvi='".$_POST['donvics']."', ngayxn='".$_POST['ngayxncs']."', thoigianct='".$_POST['thoigianctcs']."', thoigianvkk='".$_POST['thoigianvkkcs']."', ngaybbvdt='".$_POST['ngaybbvdtcs']."', giaycnbbsongay='".$_POST['giaycnbbsongaycs']."'";
