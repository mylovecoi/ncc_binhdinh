...
<script type="text/javascript" language="javascript" class="init">
			...
			{  
			   ...
			   { 
					if ($(this).find('td:last').text() == "ncc" && $(this).find('td:nth-child(54)').text().indexOf('%') >=0)
					{
...
{	
	if ($madv[3]=="Tỉnh" && $_POST['hotencs'] != "" && $_POST['ngaysinhcs'] != "" && $_POST['quequancs'] != "" && $_POST['truquancs'] != "")
	{
		...
		$sqlup = $sqlup."donvi='".$_POST['donvics']."', ngayxn='".$_POST['ngayxncs']."', thoigianct='".$_POST['thoigianctcs']."', thoigianvkk='".$_POST['thoigianvkkcs']."', ngaybbvdt='".$_POST['ngaybbvdtcs']."',gioitinhAPI=$gioitinhAPI";
